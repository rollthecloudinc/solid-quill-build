import { CdkScrollable, CdkScrollableModule, ScrollDispatcher, ViewportRuler } from "@nf-internal/chunk-FDCKYCPB";
...
import { animationFrameScheduler, merge } from "@nf-internal/chunk-BSWOS4VH";
import { BehaviorSubject, Observable, Subject, Subscription, interval } from "@nf-internal/chunk-4WPE7WTU";
...
var DragRef = class {
    ...
    _getConstrainedPointerPosition(point) {
        ...
        if (this._boundaryRect) {
            const { x: pickupX, y: pickupY } = !this.constrainPosition ? this._pickupPositionInElement : {
                x: 0,
                y: 0
            };
