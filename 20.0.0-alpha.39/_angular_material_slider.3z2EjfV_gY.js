...
import { a as v, e as S, f as g } from "@nf-internal/chunk-I4KPAEC7";
import { a as E } from "@nf-internal/chunk-4MZRILT7";
import { e as M } from "@nf-internal/chunk-5KSFOI5Q";
import { b as w } from "@nf-internal/chunk-RXMLTE5A";
import "@nf-internal/chunk-M4JCPEPJ";
import { k as y } from "@nf-internal/chunk-STIBVO4O";
import "@nf-internal/chunk-2AVGQ2MQ";
import { Directionality as L } from "@angular/cdk/bidi";
import { Platform as T } from "@angular/cdk/platform";
import * as e from "@angular/core";
import { InjectionToken as p, inject as d, ChangeDetectorRef as f, NgZone as k, Renderer2 as A, ElementRef as I, booleanAttribute as c, numberAttribute as h, forwardRef as U, EventEmitter as b, signal as z } from "@angular/core";
...
var r = (function (a) { return a[a.START = 1] = "START", a[a.END = 2] = "END", a; })(r || {}), u = (function (a) { return a[a.ACTIVE = 0] = "ACTIVE", a[a.INACTIVE = 1] = "INACTIVE", a; })(u || {}), x = new p("_MatSlider"), N = new p("_MatSliderThumb"), P = new p("_MatSliderRangeThumb"), O = new p("_MatSliderVisualThumb"), C = class {
    source;
    parent;
    value;
}, J = (() => {
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class a {
        ...
        _elementRef = d(I);
        _dir = d(L, { optional: !0 });
        _globalRippleOptions = d(S, { optional: !0 });
        _trackActive;
        _thumbs;
        _input;
        _inputs;
        ...
        _resizeTimer = null;
        _platform = d(T);
        constructor() { d(F).load(E), this._dir && (this._dirChangeSubscription = this._dir.change.subscribe(() => this._onDirChange()), this._isRtl = this._dir.value === "rtl"); }
        _knobRadius = 8;
        _inputPadding;
        ...
        static \u0275fac = function (i) { return new (i || a); };
        static \u0275cmp = e.\u0275\u0275defineComponent({ type: a, selectors: [["mat-slider"]], contentQueries: function (i, s, n) { if (i & 1 && (e.\u0275\u0275contentQuery(n, N, 5), e.\u0275\u0275contentQuery(n, P, 4)), i & 2) {
                let l;
                e.\u0275\u0275queryRefresh(l = e.\u0275\u0275loadQuery()) && (s._input = l.first), e.\u0275\u0275queryRefresh(l = e.\u0275\u0275loadQuery()) && (s._inputs = l);
            } }, viewQuery: function (i, s) { if (i & 1 && (e.\u0275\u0275viewQuery(j, 5), e.\u0275\u0275viewQuery(O, 5)), i & 2) {
                let n;
...
var tt = { provide: D, useExisting: U(() => B), multi: !0 }, it = { provide: D, useExisting: U(() => et), multi: !0 }, B = (() => { class a {
    _ngZone = d(k);
    _elementRef = d(I);
    _cdr = d(f);
    _slider = d(x);
    ...
    constructor() { let t = d(A); this._ngZone.runOutsideAngular(() => { this._listenerCleanups = [t.listen(this._hostElement, "pointerdown", this._onPointerDown.bind(this)), t.listen(this._hostElement, "pointermove", this._onPointerMove.bind(this)), t.listen(this._hostElement, "pointerup", this._onPointerUp.bind(this))]; }); }
    ...
    _fixValue(t) { let i = t.clientX - this._slider._cachedLeft, s = this._slider._cachedWidth, n = this._slider.step === 0 ? 1 : this._slider.step, l = Math.floor((this._slider.max - this._slider.min) / n), o = this._slider._isRtl ? 1 - i / s : i / s, W = Math.round(o * l) / l * (this._slider.max - this._slider.min) + this._slider.min, R = Math.round(W / n) * n, X = this.value; if (R === X) {
    ...
    static \u0275fac = function (i) { return new (i || a); };
    static \u0275dir = e.\u0275\u0275defineDirective({ type: a, selectors: [["input", "matSliderStartThumb", ""], ["input", "matSliderEndThumb", ""]], exportAs: ["matSliderRangeThumb"], features: [e.\u0275\u0275ProvidersFeature([it, { provide: P, useExisting: a }]), e.\u0275\u0275InheritDefinitionFeature] });
} return a; })(), wt = (() => { class a {
    static \u0275fac = function (i) { return new (i || a); };
    static \u0275mod = e.\u0275\u0275defineNgModule({ type: a });
    static \u0275inj = e.\u0275\u0275defineInjector({ imports: [w, V] });
} return a; })();
export { Et as MatSlider, C as MatSliderChange, wt as MatSliderModule, et as MatSliderRangeThumb, B as MatSliderThumb, J as MatSliderVisualThumb };
