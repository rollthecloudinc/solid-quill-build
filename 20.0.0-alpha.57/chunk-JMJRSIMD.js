import { a as f, b as P, c as p } from "@nf-internal/chunk-OH3XPIE7";
...
import { a as _, c as F } from "@nf-internal/chunk-JYXTBF5A";
import { a as I, c as R, d as L } from "@nf-internal/chunk-43R7O7ZH";
import { b as M } from "@nf-internal/chunk-PP4WNYUO";
import { a as E, c as V, d as T } from "@nf-internal/chunk-FYX6O4YR";
import { b as O, f as w, k as u, z as S } from "@nf-internal/chunk-STIBVO4O";
import * as o from "@angular/core";
import { InjectionToken as W, forwardRef as $, inject as s, NgZone as v, RendererFactory2 as j, ElementRef as D, Renderer2 as Y, DOCUMENT as U, ChangeDetectorRef as q, signal as y, Injector as Q, effect as X, ApplicationRef as K, DestroyRef as J, untracked as ee, afterNextRender as te, booleanAttribute as ie, Optional as re, Inject as ne, ViewContainerRef as oe, TemplateRef as se, IterableDiffers as le } from "@angular/core";
import { distinctUntilChanged as ae, auditTime as b, filter as ce, startWith as H, takeUntil as x, pairwise as de, switchMap as he, shareReplay as ue } from "rxjs/operators";
import "@angular/common";
var fe = ["contentWrapper"], pe = ["*"], G = new W("VIRTUAL_SCROLL_STRATEGY"), k = class {
...
var He = (() => { class r {
    ...
    static \u0275dir = o.\u0275\u0275defineDirective({ type: r, selectors: [["cdk-virtual-scroll-viewport", "itemSize", ""]], inputs: { itemSize: "itemSize", minBufferPx: "minBufferPx", maxBufferPx: "maxBufferPx" }, features: [o.\u0275\u0275ProvidersFeature([{ provide: G, useFactory: _e, deps: [$(() => r)] }]), o.\u0275\u0275NgOnChangesFeature] });
} return r; })(), ge = 20, me = (() => { class r {
    _ngZone = s(v);
    _platform = s(g);
    _renderer = s(j).createRenderer(null, null);
    ...
    scrolled(e = ge) { return this._platform.isBrowser ? new w(t => { this._cleanupGlobalListener || (this._cleanupGlobalListener = this._ngZone.runOutsideAngular(() => this._renderer.listen("document", "scroll", () => this._scrolled.next()))); let i = e > 0 ? this._scrolled.pipe(b(e)).subscribe(t) : this._scrolled.subscribe(t); return this._scrolledCount++, () => { i.unsubscribe(), this._scrolledCount--, this._scrolledCount || (this._cleanupGlobalListener?.(), this._cleanupGlobalListener = void 0); }; }) : S(); }
    ...
    _scrollableContainsElement(e, t) { let i = F(t), n = e.getElementRef().nativeElement; do
        if (i == n)
            return !0;
    ...
    _applyScrollToOptions(e) { let t = this.elementRef.nativeElement; P() ? t.scrollTo(e) : (e.top != null && (t.scrollTop = e.top), e.left != null && (t.scrollLeft = e.left)); }
    ...
    _change = new u;
    _document = s(U);
    constructor() { let e = s(v), t = s(j).createRenderer(null, null); e.runOutsideAngular(() => { if (this._platform.isBrowser) {
    ...
    change(e = ve) { return e > 0 ? this._change.pipe(b(e)) : this._change; }
    ...
    static \u0275fac = function (t) { return new (t || r); };
    static \u0275prov = o.\u0275\u0275defineInjectable({ token: r, factory: r.\u0275fac, providedIn: "root" });
} return r; })(), m = new W("VIRTUAL_SCROLLABLE"), z = (() => { class r extends Z {
    constructor() { super(); }
...
var Ce = typeof requestAnimationFrame < "u" ? V : E, Re = (() => {
    class r extends z {
        elementRef = s(D);
        _changeDetectorRef = s(q);
        _scrollStrategy = s(G, { optional: !0 });
        ...
        _changeDetectionNeeded = y(!1);
        _runAfterChangeDetection = [];
        _viewportChanges = O.EMPTY;
        _injector = s(Q);
        _isDestroyed = !1;
        constructor() { super(); let e = s(we); this._scrollStrategy, this._viewportChanges = e.change().subscribe(() => { this.checkViewportSize(); }), this.scrollable || (this.elementRef.nativeElement.classList.add("cdk-virtual-scrollable"), this.scrollable = this); let t = X(() => { this._changeDetectionNeeded() && this._doChangeDetection(); }, { injector: s(K).injector }); s(J).onDestroy(() => void t.destroy()); }
        ngOnInit() { this._platform.isBrowser && (this.scrollable === this && super.ngOnInit(), this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => { this._measureViewportSize(), this._scrollStrategy.attach(this), this.scrollable.elementScrolled().pipe(H(null), b(0, Ce), x(this._destroyed)).subscribe(() => this._scrollStrategy.onContentScrolled()), this._markChangeDetectionNeeded(); }))); }
        ...
        attach(e) { this._forOf, this.ngZone.runOutsideAngular(() => { this._forOf = e, this._forOf.dataStream.pipe(x(this._detachedSubject)).subscribe(t => { let i = t.length; i !== this._dataLength && (this._dataLength = i, this._scrollStrategy.onDataLengthChanged()), this._doChangeDetection(); }); }); }
        ...
        _markChangeDetectionNeeded(e) { e && this._runAfterChangeDetection.push(e), !ee(this._changeDetectionNeeded) && this.ngZone.runOutsideAngular(() => { Promise.resolve().then(() => { this.ngZone.run(() => { this._changeDetectionNeeded.set(!0); }); }); }); }
        _doChangeDetection() { this._isDestroyed || this.ngZone.run(() => { this._changeDetectorRef.markForCheck(), this._contentWrapper.nativeElement.style.transform = this._renderedContentTransform, te(() => { this._changeDetectionNeeded.set(!1); let e = this._runAfterChangeDetection; this._runAfterChangeDetection = []; for (let t of e)
...
var Ge = (() => { class r {
    ...
    set cdkVirtualForOf(e) { this._cdkVirtualForOf = e, M(e) ? this._dataSourceChanges.next(e) : this._dataSourceChanges.next(new I(T(e) ? e : Array.from(e || []))); }
    _cdkVirtualForOf;
    ...
    dataStream = this._dataSourceChanges.pipe(H(null), de(), he(([e, t]) => this._changeDataSource(e, t)), ue(1));
    _differ = null;
    _data;
    _renderedItems;
    _renderedRange;
    _needsUpdate = !1;
    _destroyed = new u;
    constructor() { let e = s(v); this.dataStream.subscribe(t => { this._data = t, this._onRenderedDataChange(); }), this._viewport.renderedRangeStream.pipe(x(this._destroyed)).subscribe(t => { this._renderedRange = t, this.viewChange.observers.length && e.run(() => this.viewChange.next(this._renderedRange)), this._onRenderedDataChange(); }), this._viewport.attach(this); }
    ...
    } return l && h ? A(t, "end", h) - A(t, "start", l) : 0; }
    ...
    _changeDataSource(e, t) { return e && e.disconnect(this), this._needsUpdate = !0, t ? t.connect(this) : S(); }
...
} return r; })(), $e = (() => { class r extends z {
    constructor() { super(); let e = s(U); this.elementRef = new D(e.documentElement), this._scrollElement = e; }
    measureBoundingClientRectWithScrollOffset(e) { return this.getElementRef().nativeElement.getBoundingClientRect()[e]; }
    static \u0275fac = function (t) { return new (t || r); };
    ...
    static \u0275fac = function (t) { return new (t || r); };
    static \u0275mod = o.\u0275\u0275defineNgModule({ type: r });
    static \u0275inj = o.\u0275\u0275defineInjector({ imports: [C, N, C, N] });
} return r; })();
export { G as a, k as b, _e as c, He as d, ge as e, me as f, Z as g, ve as h, we as i, m as j, z as k, Re as l, Ge as m, Ze as n, $e as o, N as p, Ye as q };
