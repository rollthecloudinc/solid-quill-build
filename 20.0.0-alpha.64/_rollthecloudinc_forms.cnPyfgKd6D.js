import { a as De } from "@nf-internal/chunk-EOHDPEXE";
import { a as ge } from "@nf-internal/chunk-VJMH5IEE";
import { g as Z, i as me } from "@nf-internal/chunk-FYX6O4YR";
import { D as Y, H as R, I as de, P as ue, k as j, l as I, m as pe, ma as fe, pb as ve, vb as N, z as y } from "@nf-internal/chunk-STIBVO4O";
import { a as le, b as ce, g as je } from "@nf-internal/chunk-2AVGQ2MQ";
import * as v from "@angular/common";
import { CommonModule as ze } from "@angular/common";
import * as e from "@angular/core";
import { inject as Oe, Injector as Te } from "@angular/core";
import * as a from "@angular/forms";
import { UntypedFormControl as L, FormsModule as Ee, ReactiveFormsModule as Ae } from "@angular/forms";
import { MaterialModule as ke } from "@rollthecloudinc/material";
import * as Ce from "@rollthecloudinc/content";
import { ContentBinding as Ve, ContentPluginEditorOptions as Pe, ContentPlugin as M } from "@rollthecloudinc/content";
import * as ye from "@rollthecloudinc/datasource";
import { DatasourceOptions as Ne, SelectOption as Be, Dataset as Re, mockDatasourceOptions as ee, DatasourceOptionsComponent as Ge, DatasourceModule as Le } from "@rollthecloudinc/datasource";
import * as g from "@rollthecloudinc/ordain";
import { FormValidation as Q, OrdainModule as He } from "@rollthecloudinc/ordain";
import { switchMap as D, map as b, tap as A, defaultIfEmpty as he, take as Ue, takeUntil as te, debounceTime as qe, distinctUntilChanged as Je, withLatestFrom as Qe } from "rxjs/operators";
var oe = je(De(), 1);
import * as h from "@rollthecloudinc/attributes";
import * as x from "@rollthecloudinc/token";
import * as k from "@rollthecloudinc/panels";
import { PanelPageForm as We, Pane as G, StylePlugin as Ke } from "@rollthecloudinc/panels";
import * as be from "recursive-diff";
...
import * as xe from "@rollthecloudinc/render";
import { RenderModule as Xe } from "@rollthecloudinc/render";
import { __decorate as Ye } from "tslib";
import * as T from "@angular/material/dialog";
import { MAT_DIALOG_DATA as Se } from "@angular/material/dialog";
import { RegisterRole as Ze } from "@rollthecloudinc/utils";
import * as ae from "@angular/material/button";
import * as W from "@angular/material/radio";
import * as K from "@angular/material/slider";
import * as Fe from "@angular/material/slide-toggle";
import * as _e from "@angular/material/checkbox";
import * as B from "@angular/material/datepicker";
import { Param as et, Mapping as tt } from "@rollthecloudinc/dparam";
import * as Ie from "@rollthecloudinc/media";
import { MediaFile as it } from "@rollthecloudinc/media";
import * as O from "ngx-dropzone";
import { NgxDropzoneModule as nt } from "ngx-dropzone";
import * as X from "@angular/material/chips";
function ot(n, d) { if (n & 1 && (e.\u0275\u0275elementStart(0, "mat-error"), e.\u0275\u0275element(1, "druid-ordain-default-validation-error", 2), e.\u0275\u0275elementEnd()), n & 2) {
...
function rt(n, d) { if (n & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 2), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), n & 2) {
    let t = d.$implicit;
...
function st(n, d) { if (n & 1 && (e.\u0275\u0275elementStart(0, "mat-error"), e.\u0275\u0275element(1, "druid-ordain-default-validation-error", 2), e.\u0275\u0275elementEnd()), n & 2) {
    let t = e.\u0275\u0275nextContext();
    e.\u0275\u0275advance(), e.\u0275\u0275property("validators", t.formSettings$.value == null || t.formSettings$.value.validation == null ? null : t.formSettings$.value.validation.validators)("errors", t.formControl.errors)("resolvedContext", t.resolvedContext$.value);
} }
function lt(n, d) { if (n & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 11), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), n & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t);
} }
function ct(n, d) { if (n & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "button", 12), e.\u0275\u0275listener("click", function () { e.\u0275\u0275restoreView(t); let o = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(o.fill()); }), e.\u0275\u0275text(1, "Fill in the form"), e.\u0275\u0275elementEnd();
} }
function pt(n, d) { if (n & 1 && (e.\u0275\u0275elementStart(0, "mat-radio-button", 2), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), n & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t.value), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function dt(n, d) { if (n & 1 && (e.\u0275\u0275elementStart(0, "mat-option", 4), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), n & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate(t.label);
} }
function mt(n, d) { if (n & 1) {
    let t = e.\u0275\u0275getCurrentView();
...
function vt(n, d) { if (n & 1 && (e.\u0275\u0275elementContainerStart(0), e.\u0275\u0275template(1, mt, 3, 4, "ngx-dropzone-image-preview", 2)(2, ut, 3, 4, "ngx-dropzone-video-preview", 2)(3, ft, 3, 3, "ngx-dropzone-preview", 3), e.\u0275\u0275elementContainerEnd()), n & 2) {
...
function gt(n, d) { if (n & 1 && (e.\u0275\u0275elementStart(0, "mat-chip-option", 4), e.\u0275\u0275text(1), e.\u0275\u0275elementEnd()), n & 2) {
    let t = d.$implicit;
    e.\u0275\u0275property("value", t.value), e.\u0275\u0275advance(), e.\u0275\u0275textInterpolate1(" ", t.label, " ");
} }
var H = class {
    constructor(d) { d && (this.value = d.value ? d.value : "", d.datasourceBinding && typeof d.datasourceBinding == "object" && (this.datasourceBinding = new Ve(d.datasourceBinding)), d.datasourceOptions && typeof d.datasourceOptions == "object" && (this.datasourceOptions = new Ne(d.datasourceOptions)), d.validation && (this.validation = new Q(d.validation))); }
}, ie = class {
    ...
    resolveElementOptions(t, i) { return y(t).pipe(D(o => { if (o.datasourceBinding && o.datasourceBinding.id && o.datasourceBinding.id !== "") {
        ...
        return y([o, []]); }), b(([o, r]) => [o, o.datasourceOptions && o.datasourceOptions.query !== "" ? oe.JSONPath({ path: o.datasourceOptions.query, json: r }) : r]), D(([o, r]) => this.mapDataOptions(o, r))); }
    ...
    mapDataItem(t, i) { return new Be({ value: this.tokenizerService.replaceTokens(`${t.datasourceOptions.valueMapping}`, i), label: this.tokenizerService.replaceTokens(`${t.datasourceOptions.labelMapping}`, i), dataItem: void 0 }); }
    hasDataOptions(t) { return t.datasourceBinding && t.datasourceBinding.id && t.datasourceBinding.id !== ""; }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275inject(x.TokenizerService), e.\u0275\u0275inject(k.DatasourceContentHandler), e.\u0275\u0275inject(k.PanelResolverService), e.\u0275\u0275inject(h.AttributeSerializerService)); }; }
    ...
    resolveContexts({ resolvedContext: t }) { let i = this.cachedResolvedContexts.findIndex(({ rContext: o }) => be.getDiff(o, t).length === 0); return i === -1 ? (console.log("resolved context no cache", t), i = this.cachedResolvedContexts.length, this.cachedResolvedContexts.push({ rContext: t, resolution$: new pe(1) }), this.scheduleResolution$.next({ resolvedContext: t, index: i })) : console.log("resolved context cache hit", t), this.cachedResolvedContexts[i].resolution$.pipe(fe(1)); }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275inject(x.TokenizerService), e.\u0275\u0275inject(k.FormService)); }; }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), $ = (() => { class n {
    ...
    constructor(t, i, o, r, c, p) { this.attributeSerializer = t, this.optionsResolver = i, this.tokenizerService = o, this.formsContextHelper = r, this.vpm = c, this.controlContainer = p, this.formControl = new L(""), this.formControlValueChangesSub = this.formControl.valueChanges.pipe(A(s => console.log("serialized form value", this.attributeSerializer.serialize(s, "value"))), A(s => this.controlContainer.control.get("settings").setValue([this.attributeSerializer.serialize(s, "value")]))).subscribe(), this.formSettings$ = new I(void 0), this.settings$ = new I([]), this.options$ = new I([]), this.init$ = new j, this.afterViewInit$ = new j, this.panes$ = new I([]), this.originPanes$ = new I([]), this.contexts$ = new I([]), this.resolvedContext$ = new I(void 0), this.value$ = new j, this.label$ = new I(void 0), this.settingsSub = this.settings$.pipe(b(s => s ? this.settingsToObject(this.attributeSerializer.deserializeAsObject(s)) : void 0), A(s => this.formSettings$.next(s))).subscribe(), this.loadOptionsSub = R([this.formSettings$, this.panes$, this.originPanes$, this.contexts$, this.init$]).pipe(b(([s, l, m, u]) => ({ settings: s, metadata: new Map([["panes", [...l && Array.isArray(l) ? l : [], ...m && Array.isArray(m) ? m : []]], ["contexts", u]]) })), D(({ settings: s, metadata: l }) => this.optionsResolver.resolveElementOptions(s, l)), A(s => this.options$.next(s))).subscribe(), this.renderContentSub = R([this.formSettings$, this.resolvedContext$, this.afterViewInit$]).pipe(b(([s, l]) => ({ settings: s, resolvedContext: l })), D(({ settings: s, resolvedContext: l }) => this.formsContextHelper.resolveContexts({ resolvedContext: l }).pipe(b(m => ({ settings: s, tokens: m })))), D(({ settings: s, tokens: l }) => Z(s.validation && s.validation.validators ? s.validation.validators.map(m => this.vpm.getPlugin(m.validator).pipe(D(u => u.builder({ v: m, serialized: !1 }).pipe(b(C => ({ v: m, vf: C })))))) : []).pipe(b(m => ({ settings: s, tokens: l, validators: m })), he({ settings: s, tokens: l, validators: [] }))), D(({ settings: s, tokens: l, validators: m }) => Z(s.validation && s.validation.validators ? s.validation.validators.map(u => this.vpm.getPlugin(u.validator).pipe(D(C => C.builder({ v: u, serialized: !0 }).pipe(b(z => ({ v: u, vf: z })))))) : []).pipe(b(u => ({ settings: s, tokens: l, validators: m, validatorsSerialized: u })), he({ settings: s, tokens: l, validators: m, validatorsSerialized: [] }))), A(({ settings: s, tokens: l, validators: m, validatorsSerialized: u }) => { if (this.formControl.setAsyncValidators(m.map(({ vf: C }) => C)), this.controlContainer.control.get("settings").setAsyncValidators(u.map(({ vf: C }) => C)), this.formControl.updateValueAndValidity(), this.controlContainer.control.updateValueAndValidity(), l !== void 0 && (this.tokens = l), s.value && s.value !== null && s.value !== "") {
        (s.value.indexOf(".$i.") !== -1 || s.value.indexOf(".$j.") !== -1 || s.value.indexOf(".$k.") !== -1) && console.log(s.value, this.ancestory);
        let C = s.value.split("$i"), z = C.map((E, _) => this.ancestory[_ * 1 + (3 + (_ === 0 ? 0 : 3))]), U = C.reduce((E, _, P) => [...E, P === 0 ? "" : P - 1 < z.length ? `${z[P - 1]}` : "", _], []).join("");
        console.log("path", U);
        let { resolvedValue: q, remainingExpression: $e } = this.replaceTokens(U, l);
        if (q !== void 0) {
            this.formControl.setValue(q), this.value$.next(q);
            return;
        }
        let J = this.tokenizerService.discoverTokens($e, !0);
        if (J.length !== 0)
            if (J[0].trim().lastIndexOf(".id") === J[0].trim().length - 3) {
                let E = ge();
                this.formControl.setValue(E), this.value$.next(E);
            }
            else {
                let E = Array.from(l).filter(([_]) => _.indexOf(U.substr(1, U.length - 2)) === 0);
                if (E.length !== 0) {
                    let _ = E.reduce((P, [se, we]) => ce(le({}, P), { [se.substr(se.lastIndexOf(".") + 1)]: we }), {});
                    this.formControl.setValue(_), this.value$.next(_);
                }
                else {
                    let _ = this.tokenizerService.replaceTokens(s.value, new Map(Array.from(J).map(P => [P, ""])));
                    this.formControl.setValue(_), this.value$.next(_);
                }
            }
        else
        ...
        this.formControl.setValue(""); }), Ue(1)).subscribe(); }
    ...
    ngOnInit() { this.add$.pipe(te(this.destroy$)).subscribe(() => { let t = this.panes && this.panes.length > 0 ? new G(this.panes[0]) : new G; this.panes.push(t), this.syncFormArray(); }), this.remove$.pipe(te(this.destroy$)).subscribe(t => { t > -1 && t < this.panes.length && (this.panes.splice(t, 1), this.syncFormArray()); }), R([this.settings$.pipe(b(t => t ? new ie(this.attributeSerializer.deserializeAsObject(t)) : void 0)), this.resolvedContext$, this.panel$, this.afterViewInit$]).pipe(b(([t, i, o]) => { if (i && t?.valuesMapping?.trim()) {
        let r = t.valuesMapping.split("[$i]"), c = r.map((l, m) => this.ancestory[m * 1 + 3]), p = r.reduce((l, m, u) => [...l, u === 0 ? "" : u - 1 < c.length ? `[${c[u - 1]}]` : "", m], []).join("");
        return { items: oe.JSONPath({ path: `$.${p}.*`, json: i }) };
    ...
    isData(t) { return !1; }
    getBindings(t, i, o) { return i === "pane" ? this.toObject(t).pipe(D(r => me(() => r.datasourceBinding && r.datasourceBinding.id && r.datasourceBinding.id !== null, y([r.datasourceBinding]), y([])))) : i === "context" ? y([]) : y([]); }
    fetchDynamicData(t, i) { return y(new Re); }
    ...
    editorOptions(t) { return y(new Pe); }
...
} return n; })(), Me = (() => { class n extends xt {
    static { this.\u0275fac = (() => { let t; return function (o) { return (t || (t = e.\u0275\u0275getInheritedFactory(n)))(o || n); }; })(); }
    static { this.\u0275prov = e.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), w = (() => { let n = class ne {
    get paneGroup() { return this.data.panelFormGroup.get("panes").at(this.paneIndex); }
    constructor(t, i, o, r, c) { this.data = t, this.dialogRef = i, this.fb = o, this.handler = r, this.attributeSerializer = c, this.injector = Oe(Te), this.datasourceOptions = ee, this.validation = new Q({ validators: [] }), this.hasFillButton = !1, this.bindableOptions = [], this.formGroup = this.fb.group({ value: this.fb.control(""), datasourceOptions: this.fb.control(""), validation: this.fb.control(""), datasourceBinding: this.fb.group({ id: this.fb.control(""), type: this.fb.control("pane") }) }), this.paneIndex = t.paneIndex, this.pane = t.pane; }
    ngOnInit() { this.data.pane ? this.handler.toObject(this.data.pane.settings).subscribe(t => { console.log("Form Editor Data Pane Data", t), this.formGroup.patchValue({ value: t.value, datasourceOptions: t.datasourceOptions || ee, datasourceBinding: { id: t.datasourceBinding?.id || "", type: "pane" } }), this.datasourceOptions = t.datasourceOptions || ee, this.validation = t.validation ? new Q(t.validation) : new Q({ validators: [] }); }) : (this.data.panelFormGroup.get("panes").push(this.fb.group({ contentPlugin: this.data.plugin.id, name: new L(""), label: new L(""), rule: new L(""), settings: this.fb.array([]) })), this.paneIndex = this.data.panelFormGroup.get("panes").length - 1, this.pane = new G(this.data.panelFormGroup.get("panes").at(this.paneIndex).value)), this.bindableOptions = this.data.panelFormGroup.get("panes").controls.reduce((t, i) => i.get("name").value ? [...t, i.get("name").value] : t, []); }
    ...
    setFillContent(t) { this.fillContent = t, t ? this.hasFillButton = !0 : this.hasFillButton = !1, this.datasourceOptionsComponent.setFillContent(t); }
    fill() { if (this.fillContent) {
        let t = this.fillContent.datasourceBinding;
        t && this.formGroup.patchValue({ datasourceBinding: t });
    } this.datasourceOptionsComponent.fill(); }
    static { this.\u0275fac = function (i) { return new (i || ne)(e.\u0275\u0275directiveInject(Se), e.\u0275\u0275directiveInject(T.MatDialogRef), e.\u0275\u0275directiveInject(a.UntypedFormBuilder), e.\u0275\u0275directiveInject(Me), e.\u0275\u0275directiveInject(h.AttributeSerializerService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: ne, selectors: [["druid-forms-form-element-editor"]], viewQuery: function (i, o) { if (i & 1 && e.\u0275\u0275viewQuery(Ge, 5), i & 2) {
            let r;
            e.\u0275\u0275queryRefresh(r = e.\u0275\u0275loadQuery()) && (o.datasourceOptionsComponent = r.first);
        } }, inputs: { bindableOptions: "bindableOptions" }, standalone: !1, decls: 20, vars: 4, consts: [[3, "ngSubmit", "formGroup"], ["fxLayout", "column"], ["matInput", "", "formControlName", "value"], ["formGroupName", "datasourceBinding"], ["required", "", "formControlName", "id"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "datasourceOptions"], ["formControlName", "validation", 3, "validation"], ["type", "submit", "mat-raised-button", "", "color", "primary"], ["type", "button", "matButton", "outlined", 3, "click", 4, "ngIf"], ["type", "submit", "matButton", "outlined"], [3, "value"], ["type", "button", "matButton", "outlined", 3, "click"]], template: function (i, o) { i & 1 && (e.\u0275\u0275elementStart(0, "form", 0), e.\u0275\u0275listener("ngSubmit", function () { return o.submit(); }), e.\u0275\u0275elementStart(1, "mat-dialog-content", 1)(2, "div")(3, "mat-form-field")(4, "mat-label"), e.\u0275\u0275text(5, "Value"), e.\u0275\u0275elementEnd(), e.\u0275\u0275element(6, "input", 2), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(7, "mat-form-field", 3)(8, "mat-label"), e.\u0275\u0275text(9, "Datasource"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(10, "mat-select", 4), e.\u0275\u0275template(11, lt, 2, 2, "mat-option", 5), e.\u0275\u0275elementEnd()(), e.\u0275\u0275element(12, "classifieds-ui-datasource-options", 6)(13, "druid-ordain-validation-editor", 7), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(14, "mat-dialog-actions")(15, "button", 8), e.\u0275\u0275text(16, "Save"), e.\u0275\u0275elementEnd(), e.\u0275\u0275template(17, ct, 2, 0, "button", 9), e.\u0275\u0275elementStart(18, "button", 10), e.\u0275\u0275text(19, "Save the form"), e.\u0275\u0275elementEnd()()()), i & 2 && (e.\u0275\u0275property("formGroup", o.formGroup), e.\u0275\u0275advance(11), e.\u0275\u0275property("ngForOf", o.bindableOptions), e.\u0275\u0275advance(2), e.\u0275\u0275property("validation", o.validation), e.\u0275\u0275advance(4), e.\u0275\u0275property("ngIf", o.hasFillButton)); }, dependencies: [v.NgForOf, v.NgIf, a.\u0275NgNoValidate, a.DefaultValueAccessor, a.NgControlStatus, a.NgControlStatusGroup, a.RequiredValidator, a.FormGroupDirective, a.FormControlName, a.FormGroupName, V.MatOption, ae.MatButton, T.MatDialogActions, T.MatDialogContent, f.MatInput, f.MatFormField, f.MatLabel, re.MatSelect, ye.DatasourceOptionsComponent, g.ValidationEditorComponent], encapsulation: 2 }); }
}; return n = Ye([Ze("editor")], n), n; })(), St = (() => { class n extends $ {
    constructor(t, i, o, r, c, p) { super(t, i, o, r, c, p); }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275directiveInject(h.AttributeSerializerService), e.\u0275\u0275directiveInject(S), e.\u0275\u0275directiveInject(x.TokenizerService), e.\u0275\u0275directiveInject(F), e.\u0275\u0275directiveInject(g.ValidationPluginManager), e.\u0275\u0275directiveInject(a.ControlContainer)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: n, selectors: [["druid-forms-form-radiogroup"]], standalone: !1, features: [e.\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 7, consts: [[3, "formControl", "aria-label"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]], template: function (i, o) { i & 1 && (e.\u0275\u0275elementStart(0, "mat-radio-group", 0), e.\u0275\u0275pipe(1, "async"), e.\u0275\u0275template(2, pt, 2, 2, "mat-radio-button", 1), e.\u0275\u0275pipe(3, "async"), e.\u0275\u0275elementEnd()), i & 2 && (e.\u0275\u0275property("formControl", o.formControl), e.\u0275\u0275ariaProperty("aria-label", e.\u0275\u0275pipeBind1(1, 3, o.label$)), e.\u0275\u0275advance(2), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(3, 5, o.options$))); }, dependencies: [v.NgForOf, a.NgControlStatus, a.FormControlDirective, W.MatRadioGroup, W.MatRadioButton, v.AsyncPipe], encapsulation: 2 }); }
} return n; })(), Ft = (() => { class n extends $ {
    constructor(t, i, o, r, c, p) { super(t, i, o, r, c, p); }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275directiveInject(h.AttributeSerializerService), e.\u0275\u0275directiveInject(S), e.\u0275\u0275directiveInject(x.TokenizerService), e.\u0275\u0275directiveInject(F), e.\u0275\u0275directiveInject(g.ValidationPluginManager), e.\u0275\u0275directiveInject(a.ControlContainer)); }; }
...
} return n; })(), $t = (() => { class n extends $ {
    constructor(t, i, o, r, c, p) { super(t, i, o, r, c, p), this.proxyControl = new L(""), this.optionSelected$ = new j, this.proxyControlValueChangesSub = this.proxyControl.valueChanges.pipe(qe(1e3), Je(), Qe(R([this.formSettings$, this.panes$, this.originPanes$, this.contexts$]).pipe(b(([s, l, m, u]) => ({ settings: s, panes: l, originPanes: m, contexts: u })))), b(([s, { settings: l, panes: m, originPanes: u, contexts: C }]) => ({ term: s, settings: l, metadata: new Map([["panes", [...m && Array.isArray(m) ? m : [], ...u && Array.isArray(u) ? u : []]], ["contexts", C], ["inputparams", new Map([["term", new et({ flags: [], mapping: new tt({ value: s, testValue: s, type: "static", context: void 0 }) })]])]]) })), D(({ settings: s, metadata: l }) => this.optionsResolver.resolveElementOptions(s, l)), A(s => this.options$.next(s))).subscribe(), this.optionSelectedSub = this.optionSelected$.pipe(A(s => this.formControl.setValue(s.option && s.option.value ? s.option.value.value : ""))).subscribe(), this.displayAuto = s => s.label; }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275directiveInject(h.AttributeSerializerService), e.\u0275\u0275directiveInject(S), e.\u0275\u0275directiveInject(x.TokenizerService), e.\u0275\u0275directiveInject(F), e.\u0275\u0275directiveInject(g.ValidationPluginManager), e.\u0275\u0275directiveInject(a.ControlContainer)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: n, selectors: [["druid-forms-form-autocomplete"]], standalone: !1, features: [e.\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 9, consts: [["autocomplete", "matAutocomplete"], ["matInput", "", 3, "matAutocomplete", "formControl"], [3, "optionSelected", "displayWith"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]], template: function (i, o) { if (i & 1) {
        ...
        } }, dependencies: [v.NgForOf, a.DefaultValueAccessor, a.NgControlStatus, a.FormControlDirective, V.MatAutocomplete, V.MatOption, V.MatAutocompleteTrigger, f.MatInput, f.MatFormField, f.MatLabel, v.AsyncPipe], styles: ["mat-form-field[_ngcontent-%COMP%]{display:block}"] }); }
} return n; })(), wt = (() => { class n extends $ {
    constructor(t, i, o, r, c, p, s) { super(t, i, r, c, p, s), this.files = [], this.select$ = new j, this.selectSub = this.select$.pipe(N(l => console.log(l)), de(l => this.filesService.bulkUpload({ files: [l.addedFiles[0]] }).pipe(Y(m => ({ mfs: m, e: l })))), N(({ mfs: l }) => this.formControl.setValue(l[0])), N(({ e: l }) => this.files.push(...l.addedFiles))).subscribe(), this.valueSub = this.value$.pipe(ue(l => typeof l == "object"), Y(l => new it(l)), N(l => { console.log("populate value", l); }), ve(l => this.filesService.convertToFiles([l])), N(l => { console.log("populate as file", l), this.files = l; })).subscribe(), this.filesService = o; }
    ...
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275directiveInject(Se), e.\u0275\u0275directiveInject(T.MatDialogRef), e.\u0275\u0275directiveInject(a.UntypedFormBuilder), e.\u0275\u0275directiveInject(h.AttributeSerializerService)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: n, selectors: [["classifieds-form-section-editor"]], standalone: !1, decls: 8, vars: 2, consts: [[3, "ngSubmit", "formGroup"], ["matInput", "", "formControlName", "valuesMapping"], ["type", "submit", "mat-raised-button", "", "color", "primary", "mat-dialog-close", "", 3, "disabled"]], template: function (i, o) { i & 1 && (e.\u0275\u0275elementStart(0, "form", 0), e.\u0275\u0275listener("ngSubmit", function () { return o.submit(); }), e.\u0275\u0275elementStart(1, "div")(2, "mat-form-field")(3, "mat-label"), e.\u0275\u0275text(4, "Values Mapping"), e.\u0275\u0275elementEnd(), e.\u0275\u0275element(5, "input", 1), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(6, "button", 2), e.\u0275\u0275text(7, "Save"), e.\u0275\u0275elementEnd()()), i & 2 && (e.\u0275\u0275property("formGroup", o.formGroup), e.\u0275\u0275advance(6), e.\u0275\u0275property("disabled", !o.formGroup.valid)); }, dependencies: [a.\u0275NgNoValidate, a.DefaultValueAccessor, a.NgControlStatus, a.NgControlStatusGroup, a.FormGroupDirective, a.FormControlName, ae.MatButton, T.MatDialogClose, f.MatInput, f.MatFormField, f.MatLabel], encapsulation: 2 }); }
} return n; })(), zt = (() => { class n extends $ {
    constructor(t, i, o, r, c, p) { super(t, i, o, r, c, p); }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275directiveInject(h.AttributeSerializerService), e.\u0275\u0275directiveInject(S), e.\u0275\u0275directiveInject(x.TokenizerService), e.\u0275\u0275directiveInject(F), e.\u0275\u0275directiveInject(g.ValidationPluginManager), e.\u0275\u0275directiveInject(a.ControlContainer)); }; }
    static { this.\u0275cmp = e.\u0275\u0275defineComponent({ type: n, selectors: [["druid-forms-form-listbox"]], standalone: !1, features: [e.\u0275\u0275InheritDefinitionFeature], decls: 7, vars: 7, consts: [[1, "form-listbox"], [1, "form-listbox-label"], ["multiple", "", 3, "formControl"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]], template: function (i, o) { i & 1 && (e.\u0275\u0275elementStart(0, "div", 0)(1, "label", 1), e.\u0275\u0275text(2), e.\u0275\u0275pipe(3, "async"), e.\u0275\u0275elementEnd(), e.\u0275\u0275elementStart(4, "mat-chip-listbox", 2), e.\u0275\u0275template(5, gt, 2, 2, "mat-chip-option", 3), e.\u0275\u0275pipe(6, "async"), e.\u0275\u0275elementEnd()()), i & 2 && (e.\u0275\u0275advance(2), e.\u0275\u0275textInterpolate(e.\u0275\u0275pipeBind1(3, 3, o.label$)), e.\u0275\u0275advance(2), e.\u0275\u0275property("formControl", o.formControl), e.\u0275\u0275advance(), e.\u0275\u0275property("ngForOf", e.\u0275\u0275pipeBind1(6, 5, o.options$))); }, dependencies: [v.NgForOf, a.NgControlStatus, a.FormControlDirective, X.MatChipListbox, X.MatChipOption, v.AsyncPipe], styles: [".form-listbox[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:8px}.form-listbox-label[_ngcontent-%COMP%]{font-size:12px;color:#0009}"] }); }
} return n; })(), Ot = ({ handler: n }) => new M({ id: "form_input", title: "Form Input", cls: "form-input", selectionComponent: void 0, editorComponent: w, renderComponent: ht, handler: n }), Tt = ({ handler: n }) => new M({ id: "form_select", title: "Form Select", cls: "form-select", selectionComponent: void 0, editorComponent: w, renderComponent: Ct, handler: n }), Et = ({ handler: n }) => new M({ id: "form_listbox", title: "Form Listbox", cls: "form-listbox", selectionComponent: void 0, editorComponent: w, renderComponent: zt, handler: n }), At = ({ handler: n }) => new M({ id: "form_radiogroup", title: "Form Radiogroup", cls: "form-radiogroup", selectionComponent: void 0, editorComponent: w, renderComponent: St, handler: n }), kt = ({ handler: n }) => new M({ id: "form_textarea", title: "Form Textarea", selectionComponent: void 0, editorComponent: w, renderComponent: bt, handler: n }), Vt = ({ handler: n }) => new M({ id: "form_slider", title: "Form Slider", selectionComponent: void 0, editorComponent: w, renderComponent: Ft, handler: n }), Pt = ({ handler: n }) => new M({ id: "form_toggle", title: "Form Toggle", selectionComponent: void 0, editorComponent: w, renderComponent: _t, handler: n }), Nt = ({ handler: n }) => new M({ id: "form_checkbox", title: "Form Checkbox", selectionComponent: void 0, editorComponent: w, renderComponent: It, handler: n }), Bt = ({ handler: n }) => new M({ id: "form_datepicker", title: "Form Datepicker", selectionComponent: void 0, editorComponent: w, renderComponent: Mt, handler: n }), Rt = ({ handler: n }) => new M({ id: "form_autocomplete", title: "Form Autocomplete", cls: "form-autocomplete", selectionComponent: void 0, editorComponent: w, renderComponent: $t, handler: n }), Gt = ({ handler: n }) => new M({ id: "form_media", title: "Form Media", selectionComponent: void 0, editorComponent: w, renderComponent: wt, handler: n }), Lt = ({ handler: n }) => new M({ id: "form_hidden", title: "Form Hidden", selectionComponent: void 0, editorComponent: w, renderComponent: jt, handler: n }), Ht = () => new Ke({ id: "form_section", name: "form_section", title: "Form Section", editorComponent: Dt, renderComponent: yt }), gi = (() => { class n {
    constructor(t, i, o) { [Ot({ handler: o }), Tt({ handler: o }), kt({ handler: o }), At({ handler: o }), Vt({ handler: o }), Pt({ handler: o }), Nt({ handler: o }), Bt({ handler: o }), Rt({ handler: o }), Gt({ handler: o }), Lt({ handler: o }), Et({ handler: o })].forEach(r => t.register(r)), [Ht()].forEach(r => i.register(r)); }
    static { this.\u0275fac = function (i) { return new (i || n)(e.\u0275\u0275inject(Ce.ContentPluginManager), e.\u0275\u0275inject(k.StylePluginManager), e.\u0275\u0275inject(Me)); }; }
    static { this.\u0275mod = e.\u0275\u0275defineNgModule({ type: n }); }
    static { this.\u0275inj = e.\u0275\u0275defineInjector({ imports: [ze, Ee, Ae, ke, Xe, Le, nt, He] }); }
} return n; })();
export { xt as AbstractFormContentHandler, $t as FormAutocompleteComponent, It as FormCheckboxComponent, Mt as FormDatepickerComponent, $ as FormElementBase, w as FormElementEditorComponent, Me as FormElementHandler, jt as FormHiddenComponent, ht as FormInputComponent, zt as FormListboxComponent, wt as FormMediaComponent, St as FormRadiogroupComponent, yt as FormSectionComponent, Dt as FormSectionEditorComponent, Ct as FormSelectComponent, Ft as FormSliderComponent, bt as FormTextareaComponent, _t as FormToggleComponent, gi as FormsModule, S as OptionsResolverService };
