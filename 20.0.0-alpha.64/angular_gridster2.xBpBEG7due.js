...
import { M as tt, k as W, ka as et, pb as it, tb as X } from "@nf-internal/chunk-STIBVO4O";
import { a as k, b as B } from "@nf-internal/chunk-2AVGQ2MQ";
import { NgStyle as Ct } from "@angular/common";
import * as r from "@angular/core";
import { viewChild as xt, ElementRef as ht, Renderer2 as lt, ChangeDetectorRef as vt, NgZone as dt, EventEmitter as Y } from "@angular/core";
var at = ["*"];
function Tt(n, e) { if (n & 1 && r.\u0275\u0275element(0, "div", 0), n & 2) {
    let t = e.$index, i = r.\u0275\u0275nextContext();
    r.\u0275\u0275property("ngStyle", i.gridRenderer.getGridColumnStyle(t));
} }
function bt(n, e) { if (n & 1 && r.\u0275\u0275element(0, "div", 1), n & 2) {
    let t = e.$index, i = r.\u0275\u0275nextContext();
...
var c = (function (n) { return n.Fit = "fit", n.ScrollVertical = "scrollVertical", n.ScrollHorizontal = "scrollHorizontal", n.Fixed = "fixed", n.VerticalFixed = "verticalFixed", n.HorizontalFixed = "horizontalFixed", n; })(c || {}), mt = (function (n) { return n.Always = "always", n.OnDragAndResize = "onDrag&Resize", n.None = "none", n; })(mt || {}), p = (function (n) { return n.None = "none", n.CompactUp = "compactUp", n.CompactLeft = "compactLeft", n.CompactUpAndLeft = "compactUp&Left", n.CompactLeftAndUp = "compactLeft&Up", n.CompactRight = "compactRight", n.CompactUpAndRight = "compactUp&Right", n.CompactRightAndUp = "compactRight&Up", n.CompactDown = "compactDown", n.CompactDownAndLeft = "compactDown&Left", n.CompactLeftAndDown = "compactLeft&Down", n.CompactDownAndRight = "compactDown&Right", n.CompactRightAndDown = "compactRight&Down", n.CompactGrid = "compactGrid", n; })(p || {}), f = (function (n) { return n.LTR = "ltr", n.RTL = "rtl", n; })(f || {}), O = class {
    ...
    class n {
        ...
        static \u0275cmp = r.\u0275\u0275defineComponent({ type: n, selectors: [["gridster-preview"]], inputs: { gridRenderer: "gridRenderer" }, decls: 0, vars: 0, template: function (i, s) { }, styles: [`gridster-preview{position:absolute;display:none;background:#00000026}
`], encapsulation: 2 });
    }
    return n;
})(), Ft = (() => {
    class n {
        ...
        compact;
        gridRenderer;
        calculateLayout$ = new W;
        resize$ = new W;
        destroy$ = new W;
        constructor(t, i, s, o) { this.renderer = i, this.cdRef = s, this.zone = o, this.el = t.nativeElement, this.$options = JSON.parse(JSON.stringify(_t)), this.mobile = !1, this.curWidth = 0, this.curHeight = 0, this.grid = [], this.curColWidth = 0, this.curRowHeight = 0, this.dragInProgress = !1, this.emptyCell = new G(this), this.compact = new O(this), this.gridRenderer = new A(this); }
        ...
        ngOnInit() { this.options.initCallback && this.options.initCallback(this), this.calculateLayout$.pipe(et(0), X(this.destroy$)).subscribe(() => this.calculateLayout()), this.resize$.pipe(it(() => tt(100)), X(this.destroy$)).subscribe(() => this.resize()); }
        ...
        ngOnDestroy() { this.destroy$.next(), this.windowResize && this.windowResize(), this.options && this.options.destroyCallback && this.options.destroyCallback(this), this.options && this.options.api && (this.options.api.resize = void 0, this.options.api.optionsChanged = void 0, this.options.api.getNextPossiblePosition = void 0, this.options.api = void 0), this.emptyCell.destroy(), this.emptyCell = null, this.compact.destroy(), this.compact = null; }
        ...
        removeItem(t) { this.grid.splice(this.grid.indexOf(t), 1), this.calculateLayout$.next(), this.options.itemRemovedCallback && this.options.itemRemovedCallback(t.item, t), this.movingItem && this.movingItem === t.$item && (this.movingItem = null, this.previewStyle()); }
        ...
        findItemWithItemForSwapping(t) { let i = this.grid.length - 1, s; for (; i > -1; i--)
            if (s = this.grid[i], s.$item !== t && n.checkCollisionTwoItemsForSwaping(s.$item, t))
                return s; return !1; }
        previewStyle(t = !1) { let i = this.gridsterPreview(); this.movingItem ? (this.compact && t && this.compact.checkCompactItem(this.movingItem), i.previewStyle(this.movingItem)) : i.previewStyle(null); }
        static getNewArrayLength(t, i, s) { let o = Math.max(t, Math.floor(i / s)); return o < 0 ? 0 : Number.isFinite(o) ? Math.floor(o) : 0; }
        static \u0275fac = function (i) { return new (i || n)(r.\u0275\u0275directiveInject(ht), r.\u0275\u0275directiveInject(lt), r.\u0275\u0275directiveInject(vt), r.\u0275\u0275directiveInject(dt)); };
        static \u0275cmp = r.\u0275\u0275defineComponent({ type: n, selectors: [["gridster"]], viewQuery: function (i, s) { i & 1 && r.\u0275\u0275viewQuerySignal(s.gridsterPreview, N, 5), i & 2 && r.\u0275\u0275queryAdvance(); }, inputs: { options: "options" }, features: [r.\u0275\u0275NgOnChangesFeature], ngContentSelectors: at, decls: 6, vars: 1, consts: [[1, "gridster-column", 3, "ngStyle"], [1, "gridster-row", 3, "ngStyle"], [1, "gridster-preview", 3, "gridRenderer"]], template: function (i, s) { i & 1 && (r.\u0275\u0275projectionDef(), r.\u0275\u0275repeaterCreate(0, Tt, 1, 1, "div", 0, r.\u0275\u0275repeaterTrackByIndex), r.\u0275\u0275repeaterCreate(2, bt, 1, 1, "div", 1, r.\u0275\u0275repeaterTrackByIndex), r.\u0275\u0275projection(4), r.\u0275\u0275element(5, "gridster-preview", 2)), i & 2 && (r.\u0275\u0275repeater(s.gridColumns), r.\u0275\u0275advance(2), r.\u0275\u0275repeater(s.gridRows), r.\u0275\u0275advance(3), r.\u0275\u0275property("gridRenderer", s.gridRenderer)); }, dependencies: [Ct, N], styles: [`gridster{position:relative;box-sizing:border-box;background:gray;width:100%;height:100%;-webkit-user-select:none;user-select:none;display:block}gridster.fit{overflow-x:hidden;overflow-y:hidden}gridster.scrollVertical{overflow-x:hidden;overflow-y:auto}gridster.scrollHorizontal{overflow-x:auto;overflow-y:hidden}gridster.fixed{overflow:auto}gridster.mobile{overflow-x:hidden;overflow-y:auto}gridster.mobile gridster-item{position:relative}gridster.gridSize{height:initial;width:initial}gridster.gridSize.fit{height:100%;width:100%}gridster .gridster-column,gridster .gridster-row{position:absolute;display:none;transition:.3s;box-sizing:border-box}gridster.display-grid .gridster-column,gridster.display-grid .gridster-row{display:block}gridster .gridster-column{border-left:1px solid white;border-right:1px solid white}gridster .gridster-row{border-top:1px solid white;border-bottom:1px solid white}
`], encapsulation: 2 });
    }
    return n;
})(), H = class {
...
}, P, E, ct = 50, I, M, x, L, _, F, D;
function gt(n, e, t, i, s, o, h, l, a, d) { P = n.$options.scrollSensitivity, E = n.$options.scrollSpeed, I = n.el, M = a, x = d; let u = I.offsetWidth, m = I.offsetHeight, g = I.scrollLeft, $ = I.scrollTop, T = t - $, b = m + $ - t - s, { clientX: C, clientY: v } = o; if (!n.$options.disableScrollVertical)
    if (h.clientY < v && b < P) {
        if (wt(), M && x && !x.south || D)
            return;
        D = st(1, l, h);
        ...
        h.clientY !== v && q(); let R = g + u - e - i, z = e - g; if (!n.$options.disableScrollHorizontal) {
    let S = n.$options.dirType === f.RTL, Z = h.clientX < C, K = h.clientX > C, It = S ? K : Z, $t = S ? Z : K;
    if (It && R <= P) {
        if (ft(), M && x && !x.east || L)
            return;
        L = rt(1, l, h, S);
...
function st(n, e, t) { let i = t.clientY; return window.setInterval(() => { (!I || n === -1 && I.scrollTop - E < 0) && q(), I.scrollTop += n * E, i += n * E, e({ clientX: t.clientX, clientY: i }); }, ct); }
function rt(n, e, t, i) { let s = t.clientX; return window.setInterval(() => { if (!I) {
    Q();
    return;
} let o = n * E, h = i ? -o : o; I.scrollBy({ left: h, behavior: "auto" }), s += h, e({ clientX: s, clientY: t.clientY }); }, ct); }
function pt() { Q(), q(), I = null; }
function Q() { ut(), ft(); }
function q() { wt(), yt(); }
function ut() { L && (clearInterval(L), L = 0); }
function ft() { _ && (clearInterval(_), _ = 0); }
function yt() { D && (clearInterval(D), D = 0); }
function wt() { F && (clearInterval(F), F = 0); }
var V = class {
    swapedItem;
    gridsterItem;
    gridster;
...
}, Dt = "gridster-item-resizable-handler", w = (function (n) { return n.UP = "UP", n.DOWN = "DOWN", n.LEFT = "LEFT", n.RIGHT = "RIGHT", n; })(w || {}), U = class {
    zone;
    gridsterItem;
    gridster;
    lastMouse;
    ...
    dragStartDelay = e => { if (e.target.classList.contains(Dt) || y.checkContentClassForEvent(this.gridster, e))
    ...
    class n {
        ...
        constructor(t, i, s, o) { this.renderer = s, this.zone = o, this.el = t.nativeElement, this.$item = { cols: -1, rows: -1, x: -1, y: -1 }, this.gridster = i, this.drag = new U(this, i, this.zone), this.resize = new J(this, i, this.zone); }
...
export { p as CompactType, f as DirTypes, mt as DisplayGrid, c as GridType, Ft as GridsterComponent, nt as GridsterComponentInterface, _t as GridsterConfigService, Ut as GridsterItemComponent, ot as GridsterItemComponentInterface, jt as GridsterModule, H as GridsterPush, j as GridsterPushResize, V as GridsterSwap };
