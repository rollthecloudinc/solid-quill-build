...
var defaultShareOptions, nfNamespace, global2, globalCache, externals, remoteNamesToRemote, baseUrlToRemoteNames, BUILD_NOTIFICATIONS_ENDPOINT, BuildNotificationType;
var init_softarc_native_federation_runtime = __esm({
  "node_modules/@softarc/native-federation-runtime/fesm2022/softarc-native-federation-runtime.mjs"() {
    ...
    globalCache = global2[nfNamespace];
    ...
    BUILD_NOTIFICATIONS_ENDPOINT = "/@angular-architects/native-federation:build-notifications";
...
(0, import_native_federation.initFederation)().catch((err) => console.error(err)).then((_) => import("./chunk-JSOF3NKR.js")).catch((err) => console.error(err));
//# sourceMappingURL=main-FTO5LDW2.js.map
