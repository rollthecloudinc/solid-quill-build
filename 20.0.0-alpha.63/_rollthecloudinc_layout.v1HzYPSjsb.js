...
import { AttributeValue as E, Attribute as y, AttributeTypes as x, AttributesModule as ft } from "@rollthecloudinc/attributes";
...
var On = (() => { class i {
...
} return i; })(), it = (() => { class i extends St {
    constructor(e, o) { super(e, o); }
    pluginDef() { return H(new vt({ name: "layout" })); }
    ...
    layoutSettings(e, o) { this.lpm.getPlugin("split").pipe(ht(n => this.dialog.open(Pn, { data: { layout: n, type: e, settingValues: this.settingValues(e, o) } }).afterClosed()), wt(n => !!n)).subscribe(n => { switch (e) {
        case "column":
    ...
    static { this.\u0275inj = t.\u0275\u0275defineInjector({ imports: [rt, st, Tt, dt, mt, ut, gt, xt, Ct, yt, ft] }); }
} return i; })();
export { On as FlexLayoutComponent, An as FlexLayoutRendererComponent, B as GridLayoutComponent, ci as GridLayoutEditorComponent, nt as GridlessLayoutComponent, Fn as GridlessLayoutEditorComponent, Dn as GridlessLayoutRendererComponent, Pn as LayoutDialogComponent, Gn as LayoutFormComponent, _i as LayoutModule, T as LayoutPlugin, it as LayoutPluginManager, ot as LayoutSidenavComponent, kn as SplitLayoutComponent, Rn as SplitLayoutEditorComponent };
