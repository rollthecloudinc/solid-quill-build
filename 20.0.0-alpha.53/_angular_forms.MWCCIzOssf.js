import { g as _e } from "@nf-internal/chunk-FYX6O4YR";
import { k as pe, y as me } from "@nf-internal/chunk-STIBVO4O";
import { a as c, b as h } from "@nf-internal/chunk-2AVGQ2MQ";
import * as s from "@angular/core";
import { InjectionToken as F, forwardRef as l, \u0275isPromise as ft, \u0275RuntimeError as ne, untracked as m, computed as O, signal as x, EventEmitter as C, booleanAttribute as re, ChangeDetectorRef as Fe, inject as P, ApplicationRef as gt, DestroyRef as pt, afterNextRender as mt, Version as _t } from "@angular/core";
...
} return t; })(), Vt = { provide: g, useExisting: l(() => Se), multi: !0 };
function Dt() { let t = ve() ? ve().getUserAgent() : ""; return /android (\d+)/.test(t.toLowerCase()); }
var bt = new F(""), Se = (() => { class t extends Ie {
    _compositionMode;
    _composing = !1;
...
var d = new F(""), y = new F(""), At = /^(?=.{1,254}$)(?=.{1,64}@)[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/, ye = class {
    static min(n) { return Ne(n); }
    static max(n) { return Oe(n); }
    static required(n) { return xe(n); }
    static requiredTrue(n) { return Pe(n); }
    static email(n) { return Re(n); }
    static minLength(n) { return ke(n); }
    static maxLength(n) { return je(n); }
    static pattern(n) { return Ge(n); }
    static nullValidator(n) { return L(); }
    static compose(n) { return We(n); }
    static composeAsync(n) { return $e(n); }
};
function Ne(t) { return n => { if (n.value == null || t == null)
    return null; let e = parseFloat(n.value); return !isNaN(e) && e < t ? { min: { min: t, actual: n.value } } : null; }; }
function Oe(t) { return n => { if (n.value == null || t == null)
    return null; let e = parseFloat(n.value); return !isNaN(e) && e > t ? { max: { max: t, actual: n.value } } : null; }; }
function xe(t) { return se(t.value) ? { required: !0 } : null; }
function Pe(t) { return t.value === !0 ? null : { required: !0 }; }
function Re(t) { return se(t.value) || At.test(t.value) ? null : { email: !0 }; }
function ke(t) { return n => { let e = n.value?.length ?? oe(n.value); return e === null || e === 0 ? null : e < t ? { minlength: { requiredLength: t, actualLength: e } } : null; }; }
function je(t) { return n => { let e = n.value?.length ?? oe(n.value); return e !== null && e > t ? { maxlength: { requiredLength: t, actualLength: e } } : null; }; }
function Ge(t) { if (!t)
...
function Te(t) { return t != null; }
function Be(t) { return ft(t) ? me(t) : t; }
function Ue(t) { let n = {}; return t.forEach(e => { n = e != null ? c(c({}, n), e) : n; }), Object.keys(n).length === 0 ? null : n; }
function He(t, n) { return n.map(e => e(t)); }
function Mt(t) { return !t.validate; }
function Le(t) { return t.map(n => Mt(n) ? n : e => n.validate(e)); }
function We(t) { if (!t)
    return null; let n = t.filter(Te); return n.length == 0 ? null : function (e) { return Ue(He(e, n)); }; }
function ae(t) { return t != null ? We(Le(t)) : null; }
function $e(t) { if (!t)
    return null; let n = t.filter(Te); return n.length == 0 ? null : function (e) { let i = He(e, n).map(Be); return _e(i).pipe(vt(Ue)); }; }
function le(t) { return t != null ? $e(Le(t)) : null; }
function Ce(t, n) { return t === null ? [n] : Array.isArray(t) ? [...t, n] : [t, n]; }
function qe(t) { return t._rawValidators; }
function ze(t) { return t._rawAsyncValidators; }
...
function De(t, n) { return ie(n).filter(e => !W(t, e)); }
var $ = class {
...
function Ze(t, n, e) { let i = t.controls; if (!(n ? Object.keys(i) : i).length)
    throw new ne(1e3, ""); if (!i[e])
    throw new ne(1001, ""); }
function Xe(t, n, e) { t._forEachChild((i, r) => { if (e[r] === void 0)
    throw new ne(1002, ""); }); }
var w = class {
    _pendingDirty = !1;
    ...
    removeValidators(n) { this.setValidators(De(n, this._rawValidators)); }
    removeAsyncValidators(n) { this.setAsyncValidators(De(n, this._rawAsyncValidators)); }
    ...
    _runAsyncValidator(n, e) { if (this.asyncValidator) {
        ...
        let i = Be(this.asyncValidator(this));
    ...
    setValue(n, e = {}) { Xe(this, !0, n), Object.keys(n).forEach(i => { Ze(this, !0, i), this.controls[i].setValue(n[i], { onlySelf: !0, emitEvent: e.emitEvent }); }), this.updateValueAndValidity(e); }
...
function ce(t, n) { let e = qe(t); n.validator !== null ? t.setValidators(Ce(e, n.validator)) : typeof e == "function" && t.setValidators([e]); let i = ze(t); n.asyncValidator !== null ? t.setAsyncValidators(Ce(i, n.asyncValidator)) : typeof i == "function" && t.setAsyncValidators([i]); let r = () => t.updateValueAndValidity(); K(n._rawValidators, r), K(n._rawAsyncValidators, r); }
...
function St(t, n) { n.valueAccessor.registerOnChange(e => { t._pendingValue = e, t._pendingChange = !0, t._pendingDirty = !0, t.updateOn === "change" && Ye(t, n); }); }
function Nt(t, n) { n.valueAccessor.registerOnTouched(() => { t._pendingTouched = !0, t.updateOn === "blur" && t._pendingChange && Ye(t, n), t.updateOn !== "submit" && t.markAsTouched(); }); }
function Ye(t, n) { t._pendingDirty && t.markAsDirty(), t.setValue(t._pendingValue, { emitModelToViewChange: !1 }), n.viewToModelUpdate(t._pendingValue), t._pendingChange = !1; }
...
function Je(t, n) { t._syncPendingControls(), n.forEach(e => { let i = e.control; i.updateOn === "submit" && i._pendingChange && (e.viewToModelUpdate(i._pendingValue), i._pendingChange = !1); }); }
function fe(t, n) { if (!n)
    return null; Array.isArray(n); let e, i, r; return n.forEach(o => { o.constructor === Se ? e = o : Pt(o) ? i = o : r = o; }), r || i || e || null; }
function Rt(t, n) { let e = t.indexOf(n); e > -1 && t.splice(e, 1); }
var kt = { provide: u, useExisting: l(() => Qe) }, N = Promise.resolve(), Qe = (() => { class t extends u {
    ...
    addFormGroup(e) { N.then(() => { let i = this._findContainer(e.path), r = new v({}); Ke(r, e), i.registerControl(e.name, r), r.updateValueAndValidity({ emitEvent: !1 }); }); }
    ...
    onSubmit(e) { return this.submittedReactive.set(!0), Je(this.form, this._directives), this.ngSubmit.emit(e), this.form._events.next(new Z(this.control)), e?.target?.method === "dialog"; }
...
function be(t, n) { let e = t.indexOf(n); e > -1 && t.splice(e, 1); }
function Ae(t) { return typeof t == "object" && t !== null && Object.keys(t).length === 2 && "value" in t && "disabled" in t; }
var E = class extends w {
    defaultValue = null;
    _onChange = [];
    _pendingValue;
    _pendingChange = !1;
    constructor(n = null, e, i) { super(ue(e), de(i, e)), this._applyFormState(n), this._setUpdateStrategy(e), this._initObservables(), this.updateValueAndValidity({ onlySelf: !0, emitEvent: !!this.asyncValidator }), Q(e) && (e.nonNullable || e.initialValueIsDefault) && (Ae(n) ? this.defaultValue = n.value : this.defaultValue = n); }
    ...
    _unregisterOnChange(n) { be(this._onChange, n); }
    registerOnDisabledChange(n) { this._onDisabledChange.push(n); }
    _unregisterOnDisabledChange(n) { be(this._onDisabledChange, n); }
    _forEachChild(n) { }
    ...
    _applyFormState(n) { Ae(n) ? (this.value = this._pendingValue = n.value, n.disabled ? this.disable({ onlySelf: !0, emitEvent: !1 }) : this.enable({ onlySelf: !0, emitEvent: !1 })) : this.value = this._pendingValue = n; }
}, Wn = E, jt = t => t instanceof E, et = (() => { class t extends u {
    _parent;
...
var Gt = { provide: u, useExisting: l(() => Tt) }, Tt = (() => { class t extends et {
    name = "";
    constructor(e, i, r) { super(), this._parent = e, this._setValidators(i), this._setAsyncValidators(r); }
    _checkParentType() { !(this._parent instanceof t) && this._parent instanceof Qe; }
...
} return t; })(), Bt = { provide: f, useExisting: l(() => Ut) }, Me = Promise.resolve(), Ut = (() => { class t extends f {
    _changeDetectorRef;
    callSetDisabledState;
    control = new E;
    ...
    _updateValue(e) { Me.then(() => { this.control.setValue(e, { emitViewToModelChange: !1 }), this._changeDetectorRef?.markForCheck(); }); }
    _updateDisabled(e) { let i = e.isDisabled.currentValue, r = i !== 0 && re(i); Me.then(() => { r && !this.control.disabled ? this.control.disable() : !r && this.control.disabled && this.control.enable(), this._changeDetectorRef?.markForCheck(); }); }
    _getPath(e) { return this._parent ? ee(e, this._parent) : [e]; }
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(u, 9), s.\u0275\u0275directiveInject(d, 10), s.\u0275\u0275directiveInject(y, 10), s.\u0275\u0275directiveInject(g, 10), s.\u0275\u0275directiveInject(Fe, 8), s.\u0275\u0275directiveInject(D, 8)); };
...
var $t = (() => { class t {
...
} return t; })(), Kt = { provide: u, useExisting: l(() => tt) }, tt = (() => { class t extends u {
    callSetDisabledState;
    ...
    onSubmit(e) { return this._submittedReactive.set(!0), Je(this.form, this.directives), this.ngSubmit.emit(e), this.form._events.next(new Z(this.control)), e?.target?.method === "dialog"; }
    onReset() { this.resetForm(); }
    ...
    _setUpFormContainer(e) { let i = this.form.get(e.path); Ke(i, e), i.updateValueAndValidity({ emitEvent: !1 }); }
...
} return t; })(), Jt = { provide: u, useExisting: l(() => nt) }, nt = (() => { class t extends et {
    name = null;
    constructor(e, i, r) { super(), this._parent = e, this._setValidators(i), this._setAsyncValidators(r); }
    _checkParentType() { rt(this._parent); }
...
} return t; })(), Qt = { provide: u, useExisting: l(() => it) }, it = (() => { class t extends u {
    _parent;
    name = null;
    constructor(e, i, r) { super(), this._parent = e, this._setValidators(i), this._setAsyncValidators(r); }
    ngOnInit() { rt(this._parent), this.formDirective.addFormArray(this); }
...
function rt(t) { return !(t instanceof nt) && !(t instanceof tt) && !(t instanceof it); }
...
var nn = { provide: g, useExisting: l(() => ot), multi: !0 };
function st(t, n) { return t == null ? `${n}` : (n && typeof n == "object" && (n = "Object"), `${t}: ${n}`.slice(0, 50)); }
function rn(t) { return t.split(":")[0]; }
var ot = (() => { class t extends V {
    value;
    _optionMap = new Map;
    _idCounter = 0;
    set compareWith(e) { this._compareWith = e; }
    _compareWith = Object.is;
    appRefInjector = P(gt).injector;
    destroyRef = P(pt);
    cdr = P(Fe);
    _queuedWrite = !1;
    _writeValueAfterRender() { this._queuedWrite || this.appRefInjector.destroyed || (this._queuedWrite = !0, mt({ write: () => { this.destroyRef.destroyed || (this._queuedWrite = !1, this.writeValue(this.value)); } }, { injector: this.appRefInjector })); }
    writeValue(e) { this.cdr.markForCheck(), this.value = e; let i = this._getOptionId(e), r = st(i, e); this.setProperty("value", r); }
    ...
    set ngValue(e) { this._select != null && (this._select._optionMap.set(this.id, e), this._setElementValue(st(this.id, e)), this._select._writeValueAfterRender()); }
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(s.ElementRef), s.\u0275\u0275directiveInject(s.Renderer2), s.\u0275\u0275directiveInject(ot, 9)); };
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["option"]], inputs: { ngValue: "ngValue", value: "value" }, standalone: !1 });
} return t; })(), sn = { provide: g, useExisting: l(() => at), multi: !0 };
function Ee(t, n) { return t == null ? `${n}` : (typeof n == "string" && (n = `'${n}'`), n && typeof n == "object" && (n = "Object"), `${t}: ${n}`.slice(0, 50)); }
...
var at = (() => { class t extends V {
    ...
    set ngValue(e) { this._select != null && (this._value = e, this._setElementValue(Ee(this.id, e)), this._select.writeValue(this._select.value)); }
    set value(e) { this._select ? (this._value = e, this._setElementValue(Ee(this.id, e)), this._select.writeValue(this._select.value)) : this._setElementValue(e); }
    _setElementValue(e) { this._renderer.setProperty(this._element.nativeElement, "value", e); }
    ...
    static \u0275fac = function (i) { return new (i || t)(s.\u0275\u0275directiveInject(s.ElementRef), s.\u0275\u0275directiveInject(s.Renderer2), s.\u0275\u0275directiveInject(at, 9)); };
    static \u0275dir = s.\u0275\u0275defineDirective({ type: t, selectors: [["option"]], inputs: { ngValue: "ngValue", value: "value" }, standalone: !1 });
} return t; })();
function lt(t) { return typeof t == "number" ? t : parseInt(t, 10); }
function ut(t) { return typeof t == "number" ? t : parseFloat(t); }
var b = (() => { class t {
    _validator = L;
    _onChange;
    _enabled;
...
} return t; })(), cn = { provide: d, useExisting: l(() => dt), multi: !0 }, hn = { provide: d, useExisting: l(() => fn), multi: !0 }, dt = (() => { class t extends b {
    required;
    inputName = "required";
    normalizeInput = re;
...
} return t; })(), fn = (() => { class t extends dt {
...
var ct = (() => { class t {
    ...
    setValue(n, e = {}) { Xe(this, !1, n), n.forEach((i, r) => { Ze(this, !1, r), this.at(r).setValue(i, { onlySelf: !0, emitEvent: e.emitEvent }); }), this.updateValueAndValidity(e); }
...
function we(t) { return !!t && (t.asyncValidators !== void 0 || t.validators !== void 0 || t.updateOn !== void 0); }
var ht = (() => { class t {
    useNonNullable = !1;
    get nonNullable() { let e = new t; return e.useNonNullable = !0, e; }
    group(e, i = null) { let r = this._reduceControls(e), o = {}; return we(i) ? o = i : i !== null && (o.validators = i.validator, o.asyncValidators = i.asyncValidator), new v(r, o); }
    record(e, i = null) { let r = this._reduceControls(e); return new X(r, i); }
    control(e, i, r) { let o = {}; return this.useNonNullable ? (we(i) ? o = i : (o.validators = i, o.asyncValidators = r), new E(e, h(c({}, o), { nonNullable: !0 }))) : new E(e, i, r); }
    ...
    static \u0275fac = function (i) { return new (i || t); };
    static \u0275prov = s.\u0275\u0275defineInjectable({ token: t, factory: () => P(ht).nonNullable, providedIn: "root" });
} return t; })(), Kn = (() => { class t extends ht {
    group(e, i = null) { return super.group(e, i); }
    control(e, i, r) { return super.control(e, i, r); }
    array(e, i, r) { return super.array(e, i, r); }
    static \u0275fac = (() => { let e; return function (r) { return (e || (e = s.\u0275\u0275getInheritedFactory(t)))(r || t); }; })();
    static \u0275prov = s.\u0275\u0275defineInjectable({ token: t, factory: t.\u0275fac, providedIn: "root" });
} return t; })(), Jn = new _t("20.3.7"), Qn = (() => { class t {
...
export { w as AbstractControl, $ as AbstractControlDirective, et as AbstractFormGroupDirective, bt as COMPOSITION_BUFFER_MODE, Ct as CheckboxControlValueAccessor, fn as CheckboxRequiredValidator, u as ControlContainer, _ as ControlEvent, Se as DefaultValueAccessor, pn as EmailValidator, T as FormArray, it as FormArrayName, ht as FormBuilder, E as FormControl, Yt as FormControlDirective, tn as FormControlName, v as FormGroup, tt as FormGroupDirective, nt as FormGroupName, X as FormRecord, j as FormResetEvent, Z as FormSubmittedEvent, Qn as FormsModule, yn as MaxLengthValidator, ln as MaxValidator, _n as MinLengthValidator, dn as MinValidator, y as NG_ASYNC_VALIDATORS, d as NG_VALIDATORS, g as NG_VALUE_ACCESSOR, f as NgControl, Gn as NgControlStatus, Tn as NgControlStatusGroup, Qe as NgForm, Ut as NgModel, Tt as NgModelGroup, qn as NgSelectOption, Yn as NonNullableFormBuilder, Lt as NumberValueAccessor, Vn as PatternValidator, R as PristineChangeEvent, qt as RadioControlValueAccessor, Zt as RangeValueAccessor, ei as ReactiveFormsModule, dt as RequiredValidator, ot as SelectControlValueAccessor, at as SelectMultipleControlValueAccessor, M as StatusChangeEvent, k as TouchedChangeEvent, Zn as UntypedFormArray, Kn as UntypedFormBuilder, Wn as UntypedFormControl, Bn as UntypedFormGroup, Jn as VERSION, ye as Validators, z as ValueChangeEvent, Xn as isFormArray, jt as isFormControl, Un as isFormGroup, Hn as isFormRecord, ct as \u0275InternalFormsSharedModule, $n as \u0275NgNoValidate, zn as \u0275NgSelectMultipleOption };
