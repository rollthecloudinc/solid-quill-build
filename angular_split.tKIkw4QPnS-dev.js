...
var SplitGutterDirective = class _SplitGutterDirective {
    ...
    static {
        this.ɵfac = function SplitGutterDirective_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _SplitGutterDirective)(i0.ɵɵdirectiveInject(i0.TemplateRef));
        };
    }
    static {
...
var SplitGutterDynamicInjectorDirective = class _SplitGutterDynamicInjectorDirective {
    ...
    static {
        this.ɵfac = function SplitGutterDynamicInjectorDirective_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _SplitGutterDynamicInjectorDirective)(i0.ɵɵdirectiveInject(i0.ViewContainerRef), i0.ɵɵdirectiveInject(i0.TemplateRef));
        };
    }
    static {
        this.ɵdir = /* @__PURE__ */ i0.ɵɵdefineDirective({
...
var SplitComponent = class _SplitComponent {
    ...
    static {
        this.ɵfac = function SplitComponent_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _SplitComponent)(i0.ɵɵdirectiveInject(i0.NgZone), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(i0.Renderer2), i0.ɵɵdirectiveInject(ANGULAR_SPLIT_DEFAULT_OPTIONS, 8));
        };
    }
    static {
...
var SplitAreaDirective = class _SplitAreaDirective {
    set order(v) {
    ...
    static {
        this.ɵfac = function SplitAreaDirective_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _SplitAreaDirective)(i0.ɵɵdirectiveInject(i0.NgZone), i0.ɵɵdirectiveInject(i0.Renderer2), i0.ɵɵdirectiveInject(SplitComponent), i0.ɵɵdirectiveInject(i0.ElementRef));
        };
    }
    static {
        this.ɵdir = /* @__PURE__ */ i0.ɵɵdefineDirective({
...
var SplitGutterDragHandleDirective = class _SplitGutterDragHandleDirective {
    ...
    static {
        this.ɵfac = function SplitGutterDragHandleDirective_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _SplitGutterDragHandleDirective)(i0.ɵɵdirectiveInject(GUTTER_NUM_TOKEN), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(SplitGutterDirective));
        };
    }
    static {
        this.ɵdir = /* @__PURE__ */ i0.ɵɵdefineDirective({
...
var SplitGutterExcludeFromDragDirective = class _SplitGutterExcludeFromDragDirective {
    ...
    static {
        this.ɵfac = function SplitGutterExcludeFromDragDirective_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _SplitGutterExcludeFromDragDirective)(i0.ɵɵdirectiveInject(GUTTER_NUM_TOKEN), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(SplitGutterDirective));
        };
    }
    static {
        this.ɵdir = /* @__PURE__ */ i0.ɵɵdefineDirective({
