...
import { H as P, f as G, k as b, l as f, vb as O, z as M } from "@nf-internal/chunk-STIBVO4O";
import { a as T, b as V } from "@nf-internal/chunk-2AVGQ2MQ";
...
var v = class {
    ...
    constructor(t, n, o) { this.fb = t, this.iepm = n, this.ihpm = o, this.eventPlugins$ = this.iepm.getPlugins(), this.handlerPlugins$ = this.ihpm.getPlugins(), this.listenerForm = this.fb.group({ event: this.fb.control(""), handler: this.fb.control("") }), this.contexts = [], this.listener$ = new f(new w), this.event$ = new f(new p), this.handler$ = new f(new p), this.listenerSub = this.listener$.pipe(O(a => { this.event$.next(a && a.event ? a.event : new p), this.handler$.next(a && a.handler ? a.handler : new p); })).subscribe(), this.onTouched = () => { }; }
    ...
    } })(h), A = Array.from(h); for (let l = 0; l < A.length; l++) {
        let c = A[l][0];
