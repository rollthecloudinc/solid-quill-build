import { a as L, b as Ut, d as Qs, e as Ft, f as jc, g as ot } from "@nf-internal/chunk-2AVGQ2MQ";
var al = Ft((E2, ol) => { var at = -1, Z = 1, P = 0; function cr(r, t, e, s, n) { if (r === t)
...
} return [[at, r], [Z, t]]; } function Xa(r, t, e, s) { var n = r.substring(0, e), i = t.substring(0, s), o = r.substring(e), a = t.substring(s), l = cr(n, i), u = cr(o, a); return l.concat(u); } function dn(r, t) { if (!r || !t || r.charAt(0) !== t.charAt(0))
...
var Cn = Ft((fr, He) => { var qg = 200, xl = "__lodash_hash_undefined__", vl = 9007199254740991, En = "[object Arguments]", Ig = "[object Array]", Al = "[object Boolean]", El = "[object Date]", kg = "[object Error]", Tn = "[object Function]", Tl = "[object GeneratorFunction]", as = "[object Map]", Nl = "[object Number]", Nn = "[object Object]", ll = "[object Promise]", wl = "[object RegExp]", ls = "[object Set]", Sl = "[object String]", Ll = "[object Symbol]", gn = "[object WeakMap]", Ol = "[object ArrayBuffer]", us = "[object DataView]", Cl = "[object Float32Array]", _l = "[object Float64Array]", ql = "[object Int8Array]", Il = "[object Int16Array]", kl = "[object Int32Array]", Rl = "[object Uint8Array]", Bl = "[object Uint8ClampedArray]", Ml = "[object Uint16Array]", Dl = "[object Uint32Array]", Rg = /[\\^$.*+?()[\]{}|]/g, Bg = /\w*$/, Mg = /^\[object .+?Constructor\]$/, Dg = /^(?:0|[1-9]\d*)$/, S = {}; S[En] = S[Ig] = S[Ol] = S[us] = S[Al] = S[El] = S[Cl] = S[_l] = S[ql] = S[Il] = S[kl] = S[as] = S[Nl] = S[Nn] = S[wl] = S[ls] = S[Sl] = S[Ll] = S[Rl] = S[Bl] = S[Ml] = S[Dl] = !0; S[kg] = S[Tn] = S[gn] = !1; var jg = typeof global == "object" && global && global.Object === Object && global, Pg = typeof self == "object" && self && self.Object === Object && self, _t = jg || Pg || Function("return this")(), jl = typeof fr == "object" && fr && !fr.nodeType && fr, ul = jl && typeof He == "object" && He && !He.nodeType && He, Ug = ul && ul.exports === jl; function Fg(r, t) { return r.set(t[0], t[1]), r; } function Hg(r, t) { return r.add(t), r; } function zg(r, t) { for (var e = -1, s = r ? r.length : 0; ++e < s && t(r[e], e, r) !== !1;)
    ...
    catch { } return t; } function cl(r) { var t = -1, e = Array(r.size); return r.forEach(function (s, n) { e[++t] = [n, s]; }), e; } function wn(r, t) { return function (e) { return r(t(e)); }; } function fl(r) { var t = -1, e = Array(r.size); return r.forEach(function (s) { e[++t] = s; }), e; } var Vg = Array.prototype, Wg = Function.prototype, cs = Object.prototype, mn = _t["__core-js_shared__"], hl = (function () { var r = /[^.]+$/.exec(mn && mn.keys && mn.keys.IE_PROTO || ""); return r ? "Symbol(src)_1." + r : ""; })(), Fl = Wg.toString, Xt = cs.hasOwnProperty, fs = cs.toString, Zg = RegExp("^" + Fl.call(Xt).replace(Rg, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), dl = Ug ? _t.Buffer : void 0, pl = _t.Symbol, ml = _t.Uint8Array, Qg = wn(Object.getPrototypeOf, Object), Xg = Object.create, Yg = cs.propertyIsEnumerable, Jg = Vg.splice, gl = Object.getOwnPropertySymbols, t1 = dl ? dl.isBuffer : void 0, e1 = wn(Object.keys, Object), bn = Ke(_t, "DataView"), hr = Ke(_t, "Map"), yn = Ke(_t, "Promise"), xn = Ke(_t, "Set"), vn = Ke(_t, "WeakMap"), dr = Ke(Object, "create"), r1 = he(bn), s1 = he(hr), n1 = he(yn), i1 = he(xn), o1 = he(vn), bl = pl ? pl.prototype : void 0, yl = bl ? bl.valueOf : void 0; function fe(r) { var t = -1, e = r ? r.length : 0; for (this.clear(); ++t < e;) {
    var s = r[t];
    this.set(s[0], s[1]);
...
} return Xt.call(t, r) ? t[r] : void 0; } function c1(r) { var t = this.__data__; return dr ? t[r] !== void 0 : Xt.call(t, r); } function f1(r, t) { var e = this.__data__; return e[r] = dr && t === void 0 ? xl : t, this; } fe.prototype.clear = a1; fe.prototype.delete = l1; fe.prototype.get = u1; fe.prototype.has = c1; fe.prototype.set = f1; function qt(r) { var t = -1, e = r ? r.length : 0; for (this.clear(); ++t < e;) {
    var s = r[t];
    this.set(s[0], s[1]);
...
} return e.set(r, t), this; } $e.prototype.clear = E1; $e.prototype.delete = T1; $e.prototype.get = N1; $e.prototype.has = w1; $e.prototype.set = S1; function L1(r, t) { var e = Ln(r) || X1(r) ? Kg(r.length, String) : [], s = e.length, n = !!s; for (var i in r)
    (t || Xt.call(r, i)) && !(n && (i == "length" || V1(i, s))) && e.push(i); return e; } function Hl(r, t, e) { var s = r[t]; (!(Xt.call(r, t) && Gl(s, e)) || e === void 0 && !(t in r)) && (r[t] = e); } function hs(r, t) { for (var e = r.length; e--;)
    if (Gl(r[e][0], t))
    ...
    var h = e ? z1(r) : On(r); return zg(h || r, function (p, m) { h && (m = p, p = r[m]), Hl(a, m, An(p, t, e, s, m, r, o)); }), a; } function C1(r) { return ps(r) ? Xg(r) : {}; } function _1(r, t, e) { var s = t(r); return Ln(r) ? s : $g(s, e(r)); } function q1(r) { return fs.call(r); } function I1(r) { if (!ps(r) || Z1(r))
    return !1; var t = Wl(r) || Ul(r) ? Zg : Mg; return t.test(he(r)); } function k1(r) { if (!Kl(r))
    return e1(r); var t = []; for (var e in Object(r))
    Xt.call(r, e) && e != "constructor" && t.push(e); return t; } function R1(r, t) { if (t)
    ...
    switch (s) {
        ...
        case i1: return ls;
        case o1: return gn;
    } return t; }); function $1(r) { var t = r.length, e = r.constructor(t); return t && typeof r[0] == "string" && Xt.call(r, "index") && (e.index = r.index, e.input = r.input), e; } function K1(r) { return typeof r.constructor == "function" && !Kl(r) ? C1(Qg(r)) : {}; } function G1(r, t, e, s) { var n = r.constructor; switch (t) {
    case Ol: return Sn(r);
    case Al:
...
var Fn = Ft((pr, Ve) => { var n0 = 200, Un = "__lodash_hash_undefined__", Es = 1, ou = 2, au = 9007199254740991, ms = "[object Arguments]", kn = "[object Array]", i0 = "[object AsyncFunction]", lu = "[object Boolean]", uu = "[object Date]", cu = "[object Error]", fu = "[object Function]", o0 = "[object GeneratorFunction]", gs = "[object Map]", hu = "[object Number]", a0 = "[object Null]", Ge = "[object Object]", Zl = "[object Promise]", l0 = "[object Proxy]", du = "[object RegExp]", bs = "[object Set]", pu = "[object String]", u0 = "[object Symbol]", c0 = "[object Undefined]", Rn = "[object WeakMap]", mu = "[object ArrayBuffer]", ys = "[object DataView]", f0 = "[object Float32Array]", h0 = "[object Float64Array]", d0 = "[object Int8Array]", p0 = "[object Int16Array]", m0 = "[object Int32Array]", g0 = "[object Uint8Array]", b0 = "[object Uint8ClampedArray]", y0 = "[object Uint16Array]", x0 = "[object Uint32Array]", v0 = /[\\^$.*+?()[\]{}|]/g, A0 = /^\[object .+?Constructor\]$/, E0 = /^(?:0|[1-9]\d*)$/, C = {}; C[f0] = C[h0] = C[d0] = C[p0] = C[m0] = C[g0] = C[b0] = C[y0] = C[x0] = !0; C[ms] = C[kn] = C[mu] = C[lu] = C[ys] = C[uu] = C[cu] = C[fu] = C[gs] = C[hu] = C[Ge] = C[du] = C[bs] = C[pu] = C[Rn] = !1; var gu = typeof global == "object" && global && global.Object === Object && global, T0 = typeof self == "object" && self && self.Object === Object && self, It = gu || T0 || Function("return this")(), bu = typeof pr == "object" && pr && !pr.nodeType && pr, Ql = bu && typeof Ve == "object" && Ve && !Ve.nodeType && Ve, yu = Ql && Ql.exports === bu, _n = yu && gu.process, Xl = (function () { try {
    ...
    var s = r[t];
    this.set(s[0], s[1]);
} } function Q0() { this.__data__ = [], this.size = 0; } function X0(r) { var t = this.__data__, e = Ns(t, r); if (e < 0)
    return !1; var s = t.length - 1; return e == s ? t.pop() : D0.call(t, e, 1), --this.size, !0; } function Y0(r) { var t = this.__data__, e = Ns(t, r); return e < 0 ? void 0 : t[e][1]; } function J0(r) { return Ns(this.__data__, r) > -1; } function tb(r, t) { var e = this.__data__, s = Ns(e, r); return s < 0 ? (++this.size, e.push([r, t])) : e[s][1] = t, this; } kt.prototype.clear = Q0; kt.prototype.delete = X0; kt.prototype.get = Y0; kt.prototype.has = J0; kt.prototype.set = tb; function me(r) { var t = -1, e = r == null ? 0 : r.length; for (this.clear(); ++t < e;) {
    var s = r[t];
    this.set(s[0], s[1]);
...
var Bu = Ft((z2, Yn) => {
    "use strict";
    var Hb = Object.prototype.hasOwnProperty, Q = "~";
    function xr() { }
    Object.create && (xr.prototype = Object.create(null), new xr().__proto__ || (Q = !1));
    function zb(r, t, e) { this.fn = r, this.context = t, this.once = e || !1; }
    function Ru(r, t, e, s, n) { if (typeof e != "function")
        throw new TypeError("The listener must be a function"); var i = new zb(e, s || r, n), o = Q ? Q + t : t; return r._events[o] ? r._events[o].fn ? r._events[o] = [r._events[o], i] : r._events[o].push(i) : (r._events[o] = i, r._eventsCount++), r; }
    ...
    G.prototype.eventNames = function () { var t = [], e, s; if (this._eventsCount === 0)
        ...
        Hb.call(e, s) && t.push(Q ? s.slice(1) : s); return Object.getOwnPropertySymbols ? t.concat(Object.getOwnPropertySymbols(e)) : t; };
    G.prototype.listeners = function (t) { var e = Q ? Q + t : t, s = this._events[e]; if (!s)
        return []; if (s.fn)
        return [s.fn]; for (var n = 0, i = s.length, o = new Array(i); n < i; n++)
        o[n] = s[n].fn; return o; };
    G.prototype.listenerCount = function (t) { var e = Q ? Q + t : t, s = this._events[e]; return s ? s.fn ? 1 : s.length : 0; };
    G.prototype.emit = function (t, e, s, n, i, o) { var a = Q ? Q + t : t; if (!this._events[a])
    ...
    G.prototype.removeListener = function (t, e, s, n) { var i = Q ? Q + t : t; if (!this._events[i])
        return this; if (!e)
    ...
    G.prototype.removeAllListeners = function (t) { var e; return t ? (e = Q ? Q + t : t, this._events[e] && Os(this, e)) : (this._events = new xr, this._eventsCount = 0), this; };
...
var Fi = Wc;
var Zc = "[object Null]", Qc = "[object Undefined]", Hi = ct ? ct.toStringTag : void 0;
function Xc(r) { return r == null ? r === void 0 ? Qc : Zc : Hi && Hi in Object(r) ? Ui(r) : Fi(r); }
var gt = Xc;
...
var kf = Ee ? function (r, t) { return Ee(r, "toString", { configurable: !0, enumerable: !1, value: Xi(t), writable: !0 }); } : Rr, Yi = kf;
var Rf = Qi(Yi), Ji = Rf;
...
var Ht = Zf;
function Qf(r, t, e) { if (!z(e))
    return !1; var s = typeof t; return (s == "number" ? Ht(e) && jr(t, e.length) : s == "string" && t in e) ? yt(e[t], r) : !1; }
var no = Qf;
function Xf(r) { return so(function (t, e) { var s = -1, n = e.length, i = n > 1 ? e[n - 1] : void 0, o = n > 2 ? e[2] : void 0; for (i = r.length > 3 && typeof i == "function" ? (n--, i) : void 0, o && no(e[0], e[1], o) && (i = n < 3 ? void 0 : i, n = 1), t = Object(t); ++s < n;) {
    var a = e[s];
    a && r(t, a, s, i);
} return t; }); }
var io = Xf;
...
var Xs = rh;
var ao = Object.prototype, sh = ao.hasOwnProperty, nh = ao.propertyIsEnumerable, ih = Xs((function () { return arguments; })()) ? Xs : function (r) { return H(r) && sh.call(r, "callee") && !nh.call(r, "callee"); }, rr = ih;
...
function Xh(r) { if (!z(r))
    return yo(r); var t = Ne(r), e = []; for (var s in r)
    s == "constructor" && (t || !Qh.call(r, s)) || e.push(s); return e; }
var xo = Xh;
...
function Gd() { return []; }
var Gr = Gd;
var Vd = Object.prototype, Wd = Vd.propertyIsEnumerable, Qo = Object.getOwnPropertySymbols, Zd = Qo ? function (r) { return r == null ? [] : (r = Object(r), Zo(Qo(r), function (t) { return Wd.call(r, t); })); } : Gr, ke = Zd;
function Qd(r, t) { return xt(r, ke(r), t); }
var Xo = Qd;
var Xd = Object.getOwnPropertySymbols, Yd = Xd ? function (r) { for (var t = []; r;)
...
var np = J(M, "Promise"), Qr = np;
var ip = J(M, "Set"), Xr = ip;
var ta = "[object Map]", op = "[object Object]", ea = "[object Promise]", ra = "[object Set]", sa = "[object WeakMap]", na = "[object DataView]", ap = wt(Zr), lp = wt(Kt), up = wt(Qr), cp = wt(Xr), fp = wt(Mr), ae = gt;
(Zr && ae(new Zr(new ArrayBuffer(1))) != na || Kt && ae(new Kt) != ta || Qr && ae(Qr.resolve()) != ea || Xr && ae(new Xr) != ra || Mr && ae(new Mr) != sa) && (ae = function (r) { var t = gt(r), e = t == op ? r.constructor : void 0, s = e ? wt(e) : ""; if (s)
    switch (s) {
        case ap: return na;
        case lp: return ta;
        case up: return ea;
...
var Zp = 1, Qp = 2, Xp = 4, ya = "[object Arguments]", Yp = "[object Array]", Jp = "[object Boolean]", tm = "[object Date]", em = "[object Error]", xa = "[object Function]", rm = "[object GeneratorFunction]", sm = "[object Map]", nm = "[object Number]", va = "[object Object]", im = "[object RegExp]", om = "[object Set]", am = "[object String]", lm = "[object Symbol]", um = "[object WeakMap]", cm = "[object ArrayBuffer]", fm = "[object DataView]", hm = "[object Float32Array]", dm = "[object Float64Array]", pm = "[object Int8Array]", mm = "[object Int16Array]", gm = "[object Int32Array]", bm = "[object Uint8Array]", ym = "[object Uint8ClampedArray]", xm = "[object Uint16Array]", vm = "[object Uint32Array]", w = {};
w[ya] = w[Yp] = w[cm] = w[fm] = w[Jp] = w[tm] = w[hm] = w[dm] = w[pm] = w[mm] = w[gm] = w[sm] = w[nm] = w[va] = w[im] = w[om] = w[am] = w[lm] = w[bm] = w[ym] = w[xm] = w[vm] = !0;
w[em] = w[xa] = w[um] = !1;
function ts(r, t, e, s, n, i) { var o, a = t & Zp, l = t & Qp, u = t & Xp; if (e && (o = n ? e(r, s, n, i) : e(r)), o !== void 0)
    return o; if (!z(r))
    ...
    if (f == va || f == ya || h && !n) {
        if (o = l || h ? {} : Jr(r), !a)
            return l ? Yo(r, $o(o, r)) : Xo(r, zo(o, r));
    }
    else {
        if (!w[f])
            return n ? r : {};
...
var _a = Vm;
var Wm = 1, Zm = Object.prototype, Qm = Zm.hasOwnProperty;
function Xm(r, t, e, s, n, i) { var o = e & Wm, a = nr(r), l = a.length, u = nr(t), c = u.length; if (l != c && !o)
    return !1; for (var f = l; f--;) {
    var h = a[f];
...
var ur = {};
jc(ur, { Attributor: () => W, AttributorStore: () => ar, BlockBlot: () => ue, ClassAttributor: () => D, ContainerBlot: () => Ue, EmbedBlot: () => q, InlineBlot: () => ns, LeafBlot: () => j, ParentBlot: () => et, Registry: () => Qt, Scope: () => b, ScrollBlot: () => lr, StyleAttributor: () => rt, TextBlot: () => Fe });
...
}; return r.blots = new WeakMap, r; })(), Qt = cg;
...
var nn = class extends W {
    ...
    build() { this.attributes = {}; let t = Qt.find(this.domNode); if (t == null)
    ...
    constructor(t, e) { this.scroll = t, this.domNode = e, Qt.blots.set(e, this), this.prev = null, this.next = null; }
    ...
    detach() { this.parent != null && this.parent.removeChild(this), Qt.blots.delete(this.domNode); }
...
var vg = Pe, lr = vg, fn = class Qa extends j {
    ...
    optimize(t) { super.optimize(t), this.text = this.statics.value(this.domNode), this.text.length === 0 ? this.remove() : this.next instanceof Qa && this.next.prev === this && (this.insertAt(this.length(), this.next.value()), this.next.remove()); }
...
var ku = 1, B = (() => {
    class r extends ue {
        cache = {};
        delta() { return this.cache.delta == null && (this.cache.delta = Xn(this)), this.cache.delta; }
...
`), o = i.shift();
    ...
    delta() { return new Qn.default().insert(this.value(), L(L({}, this.formats()), this.attributes.values())); }
...
function Xn(r) {
    ...
    return r.descendants(j).reduce((e, s) => s.length() === 0 ? e : e.insert(s.value(), st(s, {}, t)), new Qn.default).insert(`
`, st(r));
}
...
var ni = ut("quill:selection"), X = class {
    constructor(t) { let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0; this.index = t, this.length = e; }
}, oi = class {
    constructor(t, e) { this.emitter = e, this.scroll = t, this.composing = !1, this.mouseDown = !1, this.root = this.scroll.domNode, this.cursor = this.scroll.create("cursor", this), this.savedRange = new X(0, 0), this.lastRange = this.savedRange, this.lastNative = null, this.handleComposition(), this.handleDragging(), this.emitter.listenDOM("selectionchange", document, () => { !this.mouseDown && !this.composing && setTimeout(this.update.bind(this, x.sources.USER), 1); }), this.emitter.on(x.events.SCROLL_BEFORE_UPDATE, () => { if (!this.hasFocus())
...
function Pu(r, t) { let { index: e, length: s } = r; return new X(e + t, s); }
function Wb(r) {
    let t = [];
    return r.forEach(e => {
...
var ci = class {
    ...
    handleCompositionStart(t) { let e = t.target instanceof Node ? this.scroll.find(t.target, !0) : null; e && !(e instanceof Qe) && (this.emitter.emit(x.events.COMPOSITION_BEFORE_START, t), this.scroll.batchStart(), this.emitter.emit(x.events.COMPOSITION_START, t), this.isComposing = !0); }
...
var Xb = r => r.parentElement || r.getRootNode().host || null, Yb = r => { let t = r.getBoundingClientRect(), e = "offsetWidth" in r && Math.abs(t.width) / r.offsetWidth || 1, s = "offsetHeight" in r && Math.abs(t.height) / r.offsetHeight || 1; return { top: t.top, right: t.left + r.clientWidth * e, bottom: t.top + r.clientHeight * s, left: t.left }; }, _s = r => { let t = parseInt(r, 10); return Number.isNaN(t) ? 0 : t; }, Hu = (r, t, e, s, n, i) => r < e && t > s ? 0 : r < e ? -(e - r + n) : t > s ? t - r > s - e ? r + n - e : t - s + i : 0, Jb = (r, t) => { let e = r.ownerDocument, s = t, n = r; for (; n;) {
    ...
    n = i || a.position === "fixed" ? null : Xb(n);
} }, zu = Jb;
var ty = 100, ey = ["block", "break", "cursor", "inline", "scroll", "text"], ry = (r, t, e) => { let s = new Qt; return ey.forEach(n => { let i = t.query(n); i && s.register(i); }), r.forEach(n => { let i = t.query(n); i || e.error(`Cannot register "${n}" specified in "formats" config. Are you sure it was registered?`); let o = 0; for (; i;)
...
var d = class r {
    ...
    static imports = { delta: ee.default, parchment: ur, "core/module": k, "core/theme": Xe };
...
` });
    ...
    setSelection(t, e, s) { t == null ? this.selection.setRange(null, e || r.sources.API) : ([t, e, , s] = Dt(t, e, s), this.selection.setRange(new X(Math.max(0, t), e), s), s !== x.sources.SILENT && this.scrollSelectionIntoView()); }
...
function sy(r, t) { let e = Ku(r); if (!e)
    throw new Error("Invalid Quill container"); let n = !t.theme || t.theme === d.DEFAULTS.theme ? Xe : d.import(`themes/${t.theme}`); if (!n)
    throw new Error(`Invalid theme ${t.theme}. Did you register it?`); let p = d.DEFAULTS, { modules: i } = p, o = Qs(p, ["modules"]), m = n.DEFAULTS, { modules: a } = m, l = Qs(m, ["modules"]), u = fi(t.modules); u != null && u.toolbar && u.toolbar.constructor !== Object && (u = Ut(L({}, u), { toolbar: { container: u.toolbar } })); let c = tt({}, fi(i), fi(a), u), f = L(L(L({}, o), Gu(l)), Gu(t)), h = t.registry; return h ? t.formats && Ye.warn('Ignoring "formats" option because "registry" is specified') : h = t.formats ? $u(t.formats, f.registry, Ye) : f.registry, Ut(L({}, f), { registry: h, container: e, theme: n, modules: Object.entries(c).reduce((y, v) => { let [g, A] = v; if (!A)
...
function Vu(r, t, e, s) { let n = typeof e == "number" ? e : 0; if (r == null)
    return null; let i, o; return t && typeof t.transformPosition == "function" ? [i, o] = [r.index, r.index + r.length].map(a => t.transformPosition(a, s !== x.sources.USER)) : [i, o] = [r.index, r.index + r.length].map(a => a < t || a === t && s === x.sources.USER ? a : n >= 0 ? a + n : Math.max(t, a + n)), new X(i, o - i); }
...
var Qu = ny;
var nt = ot(lt(), 1);
var pi = { scope: b.BLOCK, whitelist: ["right", "center", "justify"] }, Xu = new W("align", "align", pi), mi = new D("align", "ql-align", pi), Is = new rt("align", "text-align", pi);
...
var Ay = ut("quill:clipboard"), Ey = [[Node.TEXT_NODE, Ry], [Node.TEXT_NODE, ac], ["br", Ly], [Node.ELEMENT_NODE, ac], [Node.ELEMENT_NODE, Sy], [Node.ELEMENT_NODE, wy], [Node.ELEMENT_NODE, Iy], ["li", _y], ["ol, ul", qy], ["pre", Oy], ["tr", ky], ["b", Ni("bold")], ["i", Ni("italic")], ["strike", Ni("strike")], ["style", Cy]], Ty = [Xu, ks].reduce((r, t) => (r[t.keyName] = t, r), {}), oc = [Is, Nr, Tr, Rs, Bs, Ms].reduce((r, t) => (r[t.keyName] = t, r), {}), lc = (() => {
    class r extends k {
...
d.register({ "blots/block": B, "blots/block/embed": U, "blots/break": $, "blots/container": dt, "blots/cursor": te, "blots/embed": Qe, "blots/inline": K, "blots/scroll": Qu, "blots/text": R, "modules/clipboard": lc, "modules/history": fc, "modules/keyboard": wr, "modules/uploader": dc, "modules/input": mc, "modules/uiNode": gc });
var Us = d;
...
var Qy = (() => { class r extends K {
    static blotName = "underline";
    static tagName = "U";
} return r; })(), Tc = Qy;
var Xy = (() => { class r extends Qe {
...
`, o = it.formats(this.children.head.domNode);
            if (s || this.forceNext || this.cachedText !== i) {
                if (i.trim().length > 0 || this.cachedText == null) {
                    let a = this.children.reduce((u, c) => u.concat(Xn(c, !1)), new zs.default), l = e(i, o);
...
var Dx = [!1, "center", "right", "justify"], jx = ["#000000", "#e60000", "#ff9900", "#ffff00", "#008a00", "#0066cc", "#9933ff", "#ffffff", "#facccc", "#ffebcc", "#ffffcc", "#cce8cc", "#cce0f5", "#ebd6ff", "#bbbbbb", "#f06666", "#ffc266", "#ffff66", "#66b966", "#66a3e0", "#c285ff", "#888888", "#a10000", "#b26b00", "#b2b200", "#006100", "#0047b2", "#6b24b2", "#444444", "#5c0000", "#663d00", "#666600", "#003700", "#002966", "#3d1466"], Px = [!1, "serif", "monospace"], Ux = ["1", "2", "3", !1], Fx = ["small", !1, "large", "huge"], Pt = class extends Xe {
...
Pt.DEFAULTS = tt({}, Xe.DEFAULTS, { modules: { toolbar: { handlers: { formula() { this.quill.theme.tooltip.edit("formula"); }, image() { let r = this.container.querySelector("input.ql-image[type=file]"); r == null && (r = document.createElement("input"), r.setAttribute("type", "file"), r.setAttribute("accept", this.quill.uploader.options.mimetypes.join(", ")), r.classList.add("ql-image"), r.addEventListener("change", () => { let t = this.quill.getSelection(!0); this.quill.uploader.upload(t, r.files), r.value = ""; }), this.container.appendChild(r)), r.click(); }, video() { this.quill.theme.tooltip.edit("video"); } } } } });
    ...
    constructor(t, e) { super(t, e), this.quill.on(x.events.EDITOR_CHANGE, (s, n, i, o) => { if (s === x.events.SELECTION_CHANGE)
        if (n != null && n.length > 0 && o === x.sources.USER) {
            ...
            if (a.length === 1) {
                ...
                let l = a[a.length - 1], u = this.quill.getIndex(l), c = Math.min(l.length() - 1, n.index + n.length - u), f = this.quill.getBounds(new X(u, c));
...
var $x = [[{ header: ["1", "2", "3", !1] }], ["bold", "italic", "underline", "link"], [{ list: "ordered" }, { list: "bullet" }], ["clean"]], ji = class extends tr {
    ...
    listen() { super.listen(), this.root.querySelector("a.ql-action").addEventListener("click", t => { this.root.classList.contains("ql-editing") ? this.save() : this.edit("link", this.preview.textContent), t.preventDefault(); }), this.root.querySelector("a.ql-remove").addEventListener("click", t => { if (this.linkRange != null) {
        ...
        if (t.length === 0 && s === x.sources.USER) {
            ...
            if (n != null) {
                this.linkRange = new X(t.index - i, n.length());
