import { defer, isObservable } from "@nf-internal/chunk-BSWOS4VH";
import { BehaviorSubject, ConnectableObservable, EMPTY, EmptyError, Observable, Subject, Subscription, combineLatest, concat, from, of, pipe, throwError } from "@nf-internal/chunk-4WPE7WTU";
...
import { ɵisPromise as _isPromise, ɵRuntimeError as _RuntimeError, Injectable, ɵisNgModule as _isNgModule, isStandalone, createEnvironmentInjector, InjectionToken, EventEmitter, input, inject, ViewContainerRef, ChangeDetectorRef, Directive, Input as Input2, Output, reflectComponentType, Component, ɵisInjectable as _isInjectable, runInInjectionContext, Compiler, NgModuleFactory, ɵresolveComponentResources as _resolveComponentResources, afterNextRender, signal, EnvironmentInjector as EnvironmentInjector2, DestroyRef, untracked, ɵConsole as _Console, ɵPendingTasksInternal as _PendingTasksInternal, ɵINTERNAL_APPLICATION_ERROR_HANDLER as _INTERNAL_APPLICATION_ERROR_HANDLER, ɵformatRuntimeError as _formatRuntimeError } from "@angular/core";
...
import { signal as signal2, untracked as untracked2, inject as inject2, ɵINTERNAL_APPLICATION_ERROR_HANDLER as _INTERNAL_APPLICATION_ERROR_HANDLER2, HostAttributeToken, ɵRuntimeError as _RuntimeError2, booleanAttribute, Directive as Directive2, Attribute, HostBinding, Input as Input3, HostListener, EventEmitter as EventEmitter2, Optional, ContentChildren, Output as Output2, Injectable as Injectable2, createEnvironmentInjector as createEnvironmentInjector2, InjectionToken as InjectionToken2, ɵpublishExternalGlobalUtil as _publishExternalGlobalUtil, makeEnvironmentProviders, APP_BOOTSTRAP_LISTENER, Injector, ApplicationRef, ɵIS_ENABLED_BLOCKING_INITIAL_NAVIGATION as _IS_ENABLED_BLOCKING_INITIAL_NAVIGATION, provideAppInitializer, ɵperformanceMarkFeature as _performanceMarkFeature, ENVIRONMENT_INITIALIZER, NgZone as NgZone2, SkipSelf, NgModule } from "@angular/core";
...
var RouterLink = class _RouterLink {
    ...
    locationStrategy;
    /** @nodoc */
    reactiveHref = signal2(null, ...(ngDevMode ? [{
    ...
    ngOnChanges(changes) {
        if (ngDevMode && isUrlTree(this.routerLinkInput) && (this.fragment !== void 0 || this.queryParams || this.queryParamsHandling || this.preserveFragment || this.relativeTo)) {
            throw new _RuntimeError2(4017, "Cannot configure queryParams or fragment when using a UrlTree as the routerLink input value.");
        }
        if (this.isAnchorElement) {
            this.updateHref();
            this.subscribeToNavigationEventsIfNecessary();
...
var PreloadAllModules = class _PreloadAllModules {
    preload(route, fn) {
        return fn().pipe(catchError2(() => of(null)));
    }
