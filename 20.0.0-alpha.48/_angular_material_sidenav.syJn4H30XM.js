import { e as E } from "@nf-internal/chunk-5KSFOI5Q";
import { b as f } from "@nf-internal/chunk-RXMLTE5A";
import { h as x, j as M } from "@nf-internal/chunk-M4JCPEPJ";
import { k as c } from "@nf-internal/chunk-STIBVO4O";
...
import { coerceBooleanProperty as l, coerceNumberProperty as F } from "@angular/cdk/coercion";
import { ESCAPE as W, hasModifierKey as G } from "@angular/cdk/keycodes";
import { Platform as b } from "@angular/cdk/platform";
import { CdkScrollable as m, ScrollDispatcher as Z, ViewportRuler as N, CdkScrollableModule as S } from "@angular/cdk/scrolling";
import * as t from "@angular/core";
import { InjectionToken as I, inject as a, ChangeDetectorRef as y, ElementRef as C, NgZone as k, Renderer2 as H, DOCUMENT as L, signal as U, EventEmitter as w, Injector as P, afterNextRender as V, QueryList as q } from "@angular/core";
import { filter as h, map as B, mapTo as T, takeUntil as d, take as K, startWith as A, debounceTime as Y } from "rxjs/operators";
...
var se = new I("MAT_DRAWER_DEFAULT_AUTOSIZE", { providedIn: "root", factory: de }), D = new I("MAT_DRAWER_CONTAINER");
function de() { return !1; }
var p = (() => { class n extends m {
    _platform = a(b);
    _changeDetectorRef = a(y);
    _container = a(v);
    constructor() { let e = a(C), r = a(Z), i = a(k); super(e, r, i); }
    ...
    _openedStream = this.openedChange.pipe(h(e => e), B(() => { }));
    openedStart = this._animationStarted.pipe(h(() => this.opened), T(void 0));
    _closedStream = this.openedChange.pipe(h(e => !e), B(() => { }));
    closedStart = this._animationStarted.pipe(h(() => !this.opened), T(void 0));
    _destroyed = new c;
    ...
    _takeFocus() { if (!this._focusTrap)
        ...
        case !0:
        case "first-tabbable":
            V(() => { !this._focusTrap.focusInitialElement() && typeof e.focus == "function" && e.focus(); }, { injector: this._injector });
            break;
        case "first-heading":
    ...
    class n {
        ...
        _watchDrawerPosition(e) { e.onPositionChanged.pipe(d(this._drawers.changes)).subscribe(() => { V({ read: () => this._validateDrawers() }, { injector: this._injector }); }); }
        _watchDrawerMode(e) { e._modeChanged.pipe(d(M(this._drawers.changes, this._destroyed))).subscribe(() => { this.updateContentMargins(), this._changeDetectorRef.markForCheck(); }); }
...
export { se as MAT_DRAWER_DEFAULT_AUTOSIZE, de as MAT_DRAWER_DEFAULT_AUTOSIZE_FACTORY, g as MatDrawer, v as MatDrawerContainer, p as MatDrawerContent, ce as MatSidenav, Ae as MatSidenavContainer, R as MatSidenavContent, Re as MatSidenavModule, Ie as matDrawerAnimations, Te as throwMatDuplicatedDrawerError };
