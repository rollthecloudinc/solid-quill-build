import { d as g, l as A } from "@nf-internal/chunk-HTPCKVAC";
import "@nf-internal/chunk-X7JSYDDX";
import "@nf-internal/chunk-4UKDDKDA";
import "@nf-internal/chunk-I4KPAEC7";
...
import { k as l, z as y } from "@nf-internal/chunk-STIBVO4O";
import { a as d } from "@nf-internal/chunk-2AVGQ2MQ";
import * as n from "@angular/core";
import { InjectionToken as C, inject as r, NgZone as E, ElementRef as R, ChangeDetectorRef as I, DOCUMENT as O, Injector as f, afterNextRender as x, TemplateRef as P } from "@angular/core";
import { _IdGenerator as j, LiveAnnouncer as F } from "@angular/cdk/a11y";
import { Platform as N } from "@angular/cdk/platform";
import { BasePortalOutlet as L, CdkPortalOutlet as S, ComponentPortal as B, TemplatePortal as z, PortalModule as V } from "@angular/cdk/portal";
...
var Y = Math.pow(2, 31) - 1, p = class {
    ...
    instance;
    containerInstance;
    _afterDismissed = new l;
    _afterOpened = new l;
    _onAction = new l;
    _durationTimeoutId;
    _dismissedByAction = !1;
    constructor(m, t) { this._overlayRef = t, this.containerInstance = m, m._onExit.subscribe(() => this._finishDismiss()); }
    ...
    _dismissAfter(m) { this._durationTimeoutId = setTimeout(() => this.dismiss(), Math.min(m, Y)); }
...
}, w = new C("MatSnackBarData"), u = class {
    politeness = "polite";
    announcementMessage = "";
    viewContainerRef;
    duration = 0;
...
`), n.\u0275\u0275advance(), n.\u0275\u0275conditional(a.hasAction ? 2 : -1));
            }, dependencies: [g, J, tt, et], styles: [`.mat-mdc-simple-snack-bar{display:flex}.mat-mdc-simple-snack-bar .mat-mdc-snack-bar-label{max-height:50vh;overflow:auto}
`], encapsulation: 2, changeDetection: 0 });
    ...
    class i extends L {
        ...
        enter() { this._destroyed || (this._animationState = "visible", this._changeDetectorRef.markForCheck(), this._changeDetectorRef.detectChanges(), this._screenReaderAnnounce(), this._animationsDisabled ? x(() => { this._ngZone.run(() => queueMicrotask(() => this.onAnimationEnd(k))); }, { injector: this._injector }) : (clearTimeout(this._enterFallback), this._enterFallback = setTimeout(() => { this._elementRef.nativeElement.classList.add("mat-snack-bar-fallback-visible"), this.onAnimationEnd(k); }, 200))); }
        exit() { return this._destroyed ? y(void 0) : (this._ngZone.run(() => { this._animationState = "hidden", this._changeDetectorRef.markForCheck(), this._elementRef.nativeElement.setAttribute("mat-exit", ""), clearTimeout(this._announceTimeoutId), this._animationsDisabled ? x(() => { this._ngZone.run(() => queueMicrotask(() => this.onAnimationEnd(v))); }, { injector: this._injector }) : (clearTimeout(this._exitFallback), this._exitFallback = setTimeout(() => this.onAnimationEnd(v), 200)); }), this._onExit); }
        ...
        static \u0275fac = function (e) { return new (e || i); };
        static \u0275cmp = n.\u0275\u0275defineComponent({ type: i, selectors: [["mat-snack-bar-container"]], viewQuery: function (e, a) { if (e & 1 && (n.\u0275\u0275viewQuery(S, 7), n.\u0275\u0275viewQuery(G, 7)), e & 2) {
                let s;
...
var it = new C("mat-snack-bar-default-options", { providedIn: "root", factory: at }), st = (() => { class i {
    _live = r(F);
    _injector = r(f);
    ...
    _attachSnackBarContainer(t, e) { let a = e && e.viewContainerRef && e.viewContainerRef.injector, s = f.create({ parent: a || this._injector, providers: [{ provide: u, useValue: e }] }), o = new B(this.snackBarContainerComponent, e.viewContainerRef, s), c = t.attach(o); return c.instance.snackBarConfig = e, c.instance; }
    _attach(t, e) { let a = d(d(d({}, new u), this._defaultConfig), e), s = this._createOverlay(a), o = this._attachSnackBarContainer(s, a), c = new p(o, s); if (t instanceof P) {
        let h = new z(t, null, { $implicit: a.data, snackBarRef: c });
        c.instance = o.attachTemplatePortal(h);
    }
    else {
        let h = this._createInjector(a, c), D = new B(t, void 0, h), T = o.attachComponentPortal(D);
    ...
    _createInjector(t, e) { let a = t && t.viewContainerRef && t.viewContainerRef.injector; return f.create({ parent: a || this._injector, providers: [{ provide: p, useValue: e }, { provide: w, useValue: t.data }] }); }
    static \u0275fac = function (e) { return new (e || i); };
...
var wt = (() => { class i {
    ...
    static \u0275inj = n.\u0275\u0275defineInjector({ providers: [st], imports: [W, V, A, b, M, b] });
...
export { w as MAT_SNACK_BAR_DATA, it as MAT_SNACK_BAR_DEFAULT_OPTIONS, at as MAT_SNACK_BAR_DEFAULT_OPTIONS_FACTORY, st as MatSnackBar, et as MatSnackBarAction, tt as MatSnackBarActions, u as MatSnackBarConfig, nt as MatSnackBarContainer, J as MatSnackBarLabel, wt as MatSnackBarModule, p as MatSnackBarRef, M as SimpleSnackBar, Mt as matSnackBarAnimations };
