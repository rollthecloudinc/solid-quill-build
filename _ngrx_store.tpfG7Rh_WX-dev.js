import { queueScheduler } from "@nf-internal/chunk-BSWOS4VH";
import { BehaviorSubject, Observable, Subject } from "@nf-internal/chunk-4WPE7WTU";
import { __spreadProps, __spreadValues } from "@nf-internal/chunk-VTXF2OHE";
// node_modules/@ngrx/store/fesm2022/ngrx-store.mjs
import * as i0 from "@angular/core";
import { Injectable, InjectionToken, Inject, computed, effect, untracked, inject, Injector as Injector2, isDevMode, makeEnvironmentProviders, provideEnvironmentInitializer, Optional, NgModule } from "@angular/core";
...
var ReducerManager = class _ReducerManager extends BehaviorSubject {
    ...
    static {
        this.ɵfac = function ReducerManager_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _ReducerManager)(i0.ɵɵinject(ReducerManagerDispatcher), i0.ɵɵinject(INITIAL_STATE), i0.ɵɵinject(INITIAL_REDUCERS), i0.ɵɵinject(REDUCER_FACTORY));
        };
    }
    static {
        this.ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
    ...
    static {
        this.ɵfac = /* @__PURE__ */ (() => {
            ...
            return function ScannedActionsSubject_Factory(__ngFactoryType__) {
                return (ɵScannedActionsSubject_BaseFactory || (ɵScannedActionsSubject_BaseFactory = i0.ɵɵgetInheritedFactory(_ScannedActionsSubject)))(__ngFactoryType__ || _ScannedActionsSubject);
            };
        })();
    }
    static {
...
var State = class _State extends BehaviorSubject {
    ...
    static {
        this.ɵfac = function State_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _State)(i0.ɵɵinject(ActionsSubject), i0.ɵɵinject(ReducerObservable), i0.ɵɵinject(ScannedActionsSubject), i0.ɵɵinject(INITIAL_STATE));
        };
    }
    static {
        this.ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
var Store = class _Store extends Observable {
    ...
    static {
        this.ɵfac = function Store_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _Store)(i0.ɵɵinject(StateObservable), i0.ɵɵinject(ActionsSubject), i0.ɵɵinject(ReducerManager), i0.ɵɵinject(i0.Injector));
        };
    }
    static {
        this.ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
var StoreRootModule = class _StoreRootModule {
    ...
    static {
        this.ɵfac = function StoreRootModule_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _StoreRootModule)(i0.ɵɵinject(ActionsSubject), i0.ɵɵinject(ReducerObservable), i0.ɵɵinject(ScannedActionsSubject), i0.ɵɵinject(Store), i0.ɵɵinject(_ROOT_STORE_GUARD, 8), i0.ɵɵinject(_ACTION_TYPE_UNIQUENESS_CHECK, 8));
        };
    }
    static {
...
var StoreFeatureModule = class _StoreFeatureModule {
    ...
    static {
        this.ɵfac = function StoreFeatureModule_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _StoreFeatureModule)(i0.ɵɵinject(_STORE_FEATURES), i0.ɵɵinject(FEATURE_REDUCERS), i0.ɵɵinject(ReducerManager), i0.ɵɵinject(StoreRootModule), i0.ɵɵinject(_ACTION_TYPE_UNIQUENESS_CHECK, 8));
        };
    }
    static {
        this.ɵmod = /* @__PURE__ */ i0.ɵɵdefineNgModule({
