...
var Ln = (() => { class i {
    ...
    layoutSettings(e, o) { this.lpm.getPlugin("split").pipe(ht(n => this.dialog.open(In, { data: { layout: n, type: e, settingValues: this.settingValues(e, o) } }).afterClosed()), wt(n => !!n)).subscribe(n => { switch (e) {
        case "column":
...
export { Ln as FlexLayoutComponent, kn as FlexLayoutRendererComponent, B as GridLayoutComponent, di as GridLayoutEditorComponent, nt as GridlessLayoutComponent, On as GridlessLayoutEditorComponent, Gn as GridlessLayoutRendererComponent, In as LayoutDialogComponent, Vn as LayoutFormComponent, ui as LayoutModule, T as LayoutPlugin, it as LayoutPluginManager, ot as LayoutSidenavComponent, Mn as SplitLayoutComponent, Pn as SplitLayoutEditorComponent };
