...
import { b as k } from "@nf-internal/chunk-JWKF23VO";
import { a as Q } from "@nf-internal/chunk-X7JSYDDX";
import { f as H, g as z } from "@nf-internal/chunk-KH4Z7I2J";
import { a as V } from "@nf-internal/chunk-4UKDDKDA";
import { e as O } from "@nf-internal/chunk-I4KPAEC7";
import { a as I } from "@nf-internal/chunk-4MZRILT7";
import { e as L } from "@nf-internal/chunk-5KSFOI5Q";
import { b as x } from "@nf-internal/chunk-RXMLTE5A";
import { j as y } from "@nf-internal/chunk-FYX6O4YR";
import { k as _ } from "@nf-internal/chunk-STIBVO4O";
import "@nf-internal/chunk-2AVGQ2MQ";
import { FocusMonitor as ci, _IdGenerator as N, FocusKeyManager as oi } from "@angular/cdk/a11y";
import { ENTER as m, SPACE as T, BACKSPACE as K, DELETE as ni, TAB as W, hasModifierKey as U, UP_ARROW as j, DOWN_ARROW as ri } from "@angular/cdk/keycodes";
import { _CdkPrivateStyleLoader as Z, _VisuallyHiddenLoader as di } from "@angular/cdk/private";
import * as t from "@angular/core";
import { InjectionToken as u, inject as r, ElementRef as g, booleanAttribute as d, numberAttribute as X, ChangeDetectorRef as J, HOST_TAG_NAME as si, NgZone as li, DOCUMENT as Y, EventEmitter as h, Injector as hi, afterNextRender as pi, QueryList as mi, forwardRef as ui } from "@angular/core";
import { takeUntil as l, startWith as b, switchMap as _i } from "rxjs/operators";
...
`, w = new u("mat-chips-default-options", { providedIn: "root", factory: () => ({ separatorKeyCodes: [m] }) }), S = new u("MatChipAvatar"), D = new u("MatChipTrailingIcon"), M = new u("MatChipEdit"), A = new u("MatChipRemove"), C = new u("MatChip"), p = (() => { class c {
    _elementRef = r(g);
    _parentChip = r(C);
    isInteractive = !0;
    _isPrimary = !0;
    ...
    constructor() { r(Z).load(I), this._elementRef.nativeElement.nodeName === "BUTTON" && this._elementRef.nativeElement.setAttribute("type", "button"); }
    ...
    _handleKeydown(i) { (i.keyCode === m || i.keyCode === T) && !this.disabled && this.isInteractive && this._isPrimary && !this._parentChip._isEditing && (i.preventDefault(), this._parentChip._handlePrimaryActionInteraction()); }
    ...
    static \u0275fac = function (a) { return new (a || c); };
    static \u0275dir = t.\u0275\u0275defineDirective({ type: c, selectors: [["mat-chip-avatar"], ["", "matChipAvatar", ""]], hostAttrs: ["role", "img", 1, "mat-mdc-chip-avatar", "mdc-evolution-chip__icon", "mdc-evolution-chip__icon--primary"], features: [t.\u0275\u0275ProvidersFeature([{ provide: S, useExisting: c }])] });
} return c; })(), yt = (() => { class c extends p {
    isInteractive = !1;
    _isPrimary = !1;
    static \u0275fac = (() => { let i; return function (e) { return (i || (i = t.\u0275\u0275getInheritedFactory(c)))(e || c); }; })();
    static \u0275dir = t.\u0275\u0275defineDirective({ type: c, selectors: [["mat-chip-trailing-icon"], ["", "matChipTrailingIcon", ""]], hostAttrs: ["aria-hidden", "true", 1, "mat-mdc-chip-trailing-icon", "mdc-evolution-chip__icon", "mdc-evolution-chip__icon--trailing"], features: [t.\u0275\u0275ProvidersFeature([{ provide: D, useExisting: c }]), t.\u0275\u0275InheritDefinitionFeature] });
} return c; })(), bt = (() => { class c extends p {
    _isPrimary = !1;
    _isLeading = !0;
    _handleClick(i) { this.disabled || (i.stopPropagation(), i.preventDefault(), this._parentChip._edit()); }
    _handleKeydown(i) { (i.keyCode === m || i.keyCode === T) && !this.disabled && (i.stopPropagation(), i.preventDefault(), this._parentChip._edit()); }
    static \u0275fac = (() => { let i; return function (e) { return (i || (i = t.\u0275\u0275getInheritedFactory(c)))(e || c); }; })();
    static \u0275dir = t.\u0275\u0275defineDirective({ type: c, selectors: [["", "matChipEdit", ""]], hostAttrs: ["role", "button", 1, "mat-mdc-chip-edit", "mat-mdc-chip-avatar", "mat-focus-indicator", "mdc-evolution-chip__icon", "mdc-evolution-chip__icon--primary"], hostVars: 1, hostBindings: function (a, e) { a & 2 && t.\u0275\u0275attribute("aria-hidden", null); }, features: [t.\u0275\u0275ProvidersFeature([{ provide: M, useExisting: c }]), t.\u0275\u0275InheritDefinitionFeature] });
} return c; })(), wt = (() => { class c extends p {
    _isPrimary = !1;
    _handleClick(i) { this.disabled || (i.stopPropagation(), i.preventDefault(), this._parentChip.remove()); }
    _handleKeydown(i) { (i.keyCode === m || i.keyCode === T) && !this.disabled && (i.stopPropagation(), i.preventDefault(), this._parentChip.remove()); }
    static \u0275fac = (() => { let i; return function (e) { return (i || (i = t.\u0275\u0275getInheritedFactory(c)))(e || c); }; })();
    static \u0275dir = t.\u0275\u0275defineDirective({ type: c, selectors: [["", "matChipRemove", ""]], hostAttrs: ["role", "button", 1, "mat-mdc-chip-remove", "mat-mdc-chip-trailing-icon", "mat-focus-indicator", "mdc-evolution-chip__icon", "mdc-evolution-chip__icon--trailing"], hostVars: 1, hostBindings: function (a, e) { a & 2 && t.\u0275\u0275attribute("aria-hidden", null); }, features: [t.\u0275\u0275ProvidersFeature([{ provide: A, useExisting: c }]), t.\u0275\u0275InheritDefinitionFeature] });
} return c; })(), v = (() => {
    class c {
        ...
        _rippleLoader = r(Q);
        _injector = r(hi);
        constructor() { let i = r(Z); i.load(I), i.load(di), this._monitorFocus(), this._rippleLoader?.configureRipple(this._elementRef.nativeElement, { className: "mat-mdc-chip-ripple", disabled: this._isRippleDisabled() }); }
        ...
        ngAfterContentInit() { this._actionChanges = y(this._allLeadingIcons.changes, this._allTrailingIcons.changes, this._allEditIcons.changes, this._allRemoveIcons.changes).subscribe(() => this._changeDetectorRef.markForCheck()); }
        ...
        static \u0275fac = function (a) { return new (a || c); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-basic-chip"], ["", "mat-basic-chip", ""], ["mat-chip"], ["", "mat-chip", ""]], contentQueries: function (a, e, n) { if (a & 1 && (t.\u0275\u0275contentQuery(n, S, 5), t.\u0275\u0275contentQuery(n, M, 5), t.\u0275\u0275contentQuery(n, D, 5), t.\u0275\u0275contentQuery(n, A, 5), t.\u0275\u0275contentQuery(n, S, 5), t.\u0275\u0275contentQuery(n, D, 5), t.\u0275\u0275contentQuery(n, M, 5), t.\u0275\u0275contentQuery(n, A, 5)), a & 2) {
                let o;
...
`], encapsulation: 2, changeDetection: 0 });
...
}, Li = (() => { class c extends v {
    _defaultOptions = r(w, { optional: !0 });
    ...
    static \u0275fac = function (a) { return new (a || c); };
    static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-chip-row"], ["", "mat-chip-row", ""], ["mat-basic-chip-row"], ["", "mat-basic-chip-row", ""]], contentQueries: function (a, e, n) { if (a & 1 && t.\u0275\u0275contentQuery(n, E, 5), a & 2) {
            let o;
            t.\u0275\u0275queryRefresh(o = t.\u0275\u0275loadQuery()) && (e.contentEditInput = o.first);
        } }, viewQuery: function (a, e) { if (a & 1 && t.\u0275\u0275viewQuery(E, 5), a & 2) {
            let n;
            t.\u0275\u0275queryRefresh(n = t.\u0275\u0275loadQuery()) && (e.defaultEditInput = n.first);
        } }, hostAttrs: [1, "mat-mdc-chip", "mat-mdc-chip-row", "mdc-evolution-chip"], hostVars: 29, hostBindings: function (a, e) { a & 1 && t.\u0275\u0275listener("focus", function () { return e._handleFocus(); })("click", function (o) { return e._handleClick(o); })("dblclick", function (o) { return e._handleDoubleclick(o); }), a & 2 && (t.\u0275\u0275domProperty("id", e.id), t.\u0275\u0275attribute("tabindex", e.disabled ? null : -1)("aria-label", null)("aria-description", null)("role", e.role), t.\u0275\u0275classProp("mat-mdc-chip-with-avatar", e.leadingIcon)("mat-mdc-chip-disabled", e.disabled)("mat-mdc-chip-editing", e._isEditing)("mat-mdc-chip-editable", e.editable)("mdc-evolution-chip--disabled", e.disabled)("mdc-evolution-chip--with-leading-action", e._hasLeadingActionIcon())("mdc-evolution-chip--with-trailing-action", e._hasTrailingIcon())("mdc-evolution-chip--with-primary-graphic", e.leadingIcon)("mdc-evolution-chip--with-primary-icon", e.leadingIcon)("mdc-evolution-chip--with-avatar", e.leadingIcon)("mat-mdc-chip-highlighted", e.highlighted)("mat-mdc-chip-with-trailing-icon", e._hasTrailingIcon())); }, inputs: { editable: "editable" }, outputs: { edited: "edited" }, features: [t.\u0275\u0275ProvidersFeature([{ provide: v, useExisting: c }, { provide: C, useExisting: c }]), t.\u0275\u0275InheritDefinitionFeature], ngContentSelectors: Si, decls: 9, vars: 8, consts: [[1, "mat-mdc-chip-focus-overlay"], ["role", "gridcell", 1, "mdc-evolution-chip__cell", "mdc-evolution-chip__cell--leading"], ["role", "gridcell", "matChipAction", "", 1, "mdc-evolution-chip__cell", "mdc-evolution-chip__cell--primary", 3, "disabled"], [1, "mdc-evolution-chip__graphic", "mat-mdc-chip-graphic"], [1, "mdc-evolution-chip__text-label", "mat-mdc-chip-action-label"], ["aria-hidden", "true", 1, "mat-mdc-chip-primary-focus-indicator", "mat-focus-indicator"], ["role", "gridcell", 1, "mdc-evolution-chip__cell", "mdc-evolution-chip__cell--trailing"], ["matChipEditInput", ""]], template: function (a, e) { a & 1 && (t.\u0275\u0275projectionDef(Ei), t.\u0275\u0275conditionalCreate(0, Di, 1, 0, "span", 0), t.\u0275\u0275conditionalCreate(1, Mi, 2, 0, "span", 1), t.\u0275\u0275elementStart(2, "span", 2), t.\u0275\u0275conditionalCreate(3, Ai, 2, 0, "span", 3), t.\u0275\u0275elementStart(4, "span", 4), t.\u0275\u0275conditionalCreate(5, Ti, 2, 1)(6, Bi, 1, 0), t.\u0275\u0275element(7, "span", 5), t.\u0275\u0275elementEnd()(), t.\u0275\u0275conditionalCreate(8, Pi, 2, 0, "span", 6)), a & 2 && (t.\u0275\u0275conditional(e._isEditing ? -1 : 0), t.\u0275\u0275advance(), t.\u0275\u0275conditional(e._hasLeadingActionIcon() ? 1 : -1), t.\u0275\u0275advance(), t.\u0275\u0275property("disabled", e.disabled), t.\u0275\u0275attribute("aria-description", e.ariaDescription)("aria-label", e.ariaLabel), t.\u0275\u0275advance(), t.\u0275\u0275conditional(e.leadingIcon ? 3 : -1), t.\u0275\u0275advance(2), t.\u0275\u0275conditional(e._isEditing ? 5 : 6), t.\u0275\u0275advance(3), t.\u0275\u0275conditional(e._hasTrailingIcon() ? 8 : -1)); }, dependencies: [p, E], styles: [ti], encapsulation: 2, changeDetection: 0 });
} return c; })(), ai = (() => {
    class c {
        _elementRef = r(g);
        _changeDetectorRef = r(J);
        ...
        static \u0275fac = function (a) { return new (a || c); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: c, selectors: [["mat-chip-set"]], contentQueries: function (a, e, n) { if (a & 1 && t.\u0275\u0275contentQuery(n, v, 5), a & 2) {
                let o;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    _propagateChanges() { let i = null; Array.isArray(this.selected) ? i = this.selected.map(a => a.value) : i = this.selected ? this.selected.value : void 0, this._value = i, this.change.emit(new F(this, i)), this._onChange(i), this._changeDetectorRef.markForCheck(); }
    ...
    constructor() { super(); let i = r(bi, { optional: !0 }), a = r(wi, { optional: !0 }), e = r(k); this.ngControl && (this.ngControl.valueAccessor = this), this._errorStateTracker = new G(e, this.ngControl, a, i, this.stateChanges); }
    ngAfterContentInit() { this.chipBlurChanges.pipe(l(this._destroyed)).subscribe(() => { this._blur(), this.stateChanges.next(); }), y(this.chipFocusChanges, this._chips.changes).pipe(l(this._destroyed)).subscribe(() => this.stateChanges.next()); }
    ...
    _handleKeydown(i) { let a = i.keyCode, e = this._keyManager.activeItem; if (a === W)
        ...
        if ((a === j || a === ri) && e) {
            let n = this._chipActions.filter(P => P._isPrimary === e._isPrimary && !this._skipPredicate(P)), o = n.indexOf(e), f = i.keyCode === j ? -1 : 1;
            i.preventDefault(), o > -1 && this._isValidIndex(o + f) && this._keyManager.setActiveItem(n[o + f]);
        }
        else
            super._handleKeydown(i); this.stateChanges.next(); }
    _focusLastChip() { this._chips.length && this._chips.last.focus(); }
    _propagateChanges() { let i = this._chips.length ? this._chips.toArray().map(a => a.value) : []; this._value = i, this.change.emit(new R(this, i)), this.valueChange.emit(i), this._onChange(i), this._changeDetectorRef.markForCheck(); }
    ...
    inputElement;
    constructor() { let i = r(w), a = r(z, { optional: !0 }); this.inputElement = this._elementRef.nativeElement, this.separatorKeyCodes = i.separatorKeyCodes, this.disabledInteractive = i.inputDisabledInteractive ?? !1, a && this.inputElement.classList.add("mat-mdc-form-field-input-control"); }
...
var xt = (() => { class c {
    ...
    static \u0275inj = t.\u0275\u0275defineInjector({ providers: [k, { provide: w, useValue: { separatorKeyCodes: [m] } }], imports: [x, V, x] });
} return c; })();
export { C as MAT_CHIP, w as MAT_CHIPS_DEFAULT_OPTIONS, S as MAT_CHIP_AVATAR, M as MAT_CHIP_EDIT, Hi as MAT_CHIP_LISTBOX_CONTROL_VALUE_ACCESSOR, A as MAT_CHIP_REMOVE, D as MAT_CHIP_TRAILING_ICON, v as MatChip, ft as MatChipAvatar, bt as MatChipEdit, E as MatChipEditInput, Ct as MatChipGrid, R as MatChipGridChange, It as MatChipInput, zi as MatChipListbox, F as MatChipListboxChange, Li as MatChipOption, wt as MatChipRemove, Oi as MatChipRow, q as MatChipSelectionChange, ai as MatChipSet, yt as MatChipTrailingIcon, xt as MatChipsModule };
