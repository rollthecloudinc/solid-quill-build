import { e as g } from "@nf-internal/chunk-YWLUDWUY";
import "@nf-internal/chunk-M4JCPEPJ";
import { z as f } from "@nf-internal/chunk-STIBVO4O";
import { a as d, b as u } from "@nf-internal/chunk-2AVGQ2MQ";
import * as t from "@angular/core";
import { EventEmitter as C, forwardRef as _ } from "@angular/core";
import * as s from "@angular/common";
import { CommonModule as w } from "@angular/common";
import * as o from "@angular/forms";
import { Validators as v, NG_VALUE_ACCESSOR as M, NG_VALIDATORS as T, ReactiveFormsModule as b, FormsModule as k } from "@angular/forms";
import * as l from "angular-split";
import { AngularSplitModule as E } from "angular-split";
import { MaterialModule as j } from "@rollthecloudinc/material";
import { NgxJsonViewerModule as D } from "ngx-json-viewer";
import * as h from "ngx-markdown";
import { MarkdownModule as I } from "ngx-markdown";
import * as S from "@rollthecloudinc/utils";
import { UtilsModule as N } from "@rollthecloudinc/utils";
import { distinctUntilChanged as O, debounceTime as V, map as G } from "rxjs/operators";
import * as y from "@angular/material/autocomplete";
import * as F from "@angular/material/button";
import * as m from "@angular/material/dialog";
import * as p from "@angular/material/input";
import * as x from "@angular/material/select";
...
var c = class {
    ...
    constructor(e) { this.fb = e, this.submitted = new C, this.splitDirection = "vertical", this.rows = 40, this.cols = 100, this.rootForm = !0, this.onTouched = () => { }, this.contentForm = this.fb.group({ content: this.fb.control("", v.required), contentType: this.fb.control("", v.required), jsScript: this.fb.control("") }), this.isMarkdown = !1, this.contentEditorOptions = { theme: "vs-dark", language: "text/html" }; }
    ngOnInit() { this.contentForm.get("content").valueChanges.pipe(O(), V(500), G(e => this.tokens !== void 0 ? this.replaceTokens(e) : e)).subscribe(e => { this.preview = e; }), this.contentForm.get("contentType").valueChanges.subscribe(e => { this.isMarkdown = e === "text/markdown"; }); }
