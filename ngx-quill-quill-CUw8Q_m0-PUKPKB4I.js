import { __commonJS, __export, __objRest, __spreadProps, __spreadValues, __toESM } from "@nf-internal/chunk-VTXF2OHE";
...
var require_lodash2 = __commonJS({
    "node_modules/lodash.isequal/index.js"(exports2, module2) {
        ...
        function arrayLikeKeys2(value, inherited) {
            ...
            for (var key in value) {
                if ((inherited || hasOwnProperty14.call(value, key)) && !(skipIndexes && (
...
function arrayLikeKeys(value, inherited) {
    ...
    for (var key in value) {
        if ((inherited || hasOwnProperty5.call(value, key)) && !(skipIndexes && (
        // Safari 9 has enumerable `arguments.length` in strict mode.
        key == "length" ||
            // Node.js 0.10 has enumerable non-index properties on buffers.
            isBuff && (key == "offset" || key == "parent") ||
...
var Inline = class _Inline extends InlineBlot$1 {
    ...
    static order = ["cursor", "inline",
        ...
        "underline", "strike", "italic", "bold", "script", "code"
        // Must be higher
    ];
...
function expandConfig(containerOrSelector, options) {
    ...
    const _a = Quill.DEFAULTS, { modules: quillModuleDefaults } = _a, quillDefaults = __objRest(_a, ["modules"]);
    const _b = theme.DEFAULTS, { modules: themeModuleDefaults } = _b, themeDefaults = __objRest(_b, ["modules"]);
            ...
            case "formula":
                {
                    ...
                    if (range != null) {
                        ...
                        // @ts-expect-error Fix me later
                        this.root.getAttribute("data-mode"), value, emitter_default.sources.USER);
