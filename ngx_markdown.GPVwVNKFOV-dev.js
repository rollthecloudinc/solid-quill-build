...
import { Subject, of, timer } from "@nf-internal/chunk-4WPE7WTU";
...
import { computed, ChangeDetectionStrategy, Component, InjectionToken, Pipe, PLATFORM_ID, Inject, Optional, Injectable, EventEmitter, Output, Input, SecurityContext as SecurityContext2, NgModule } from "@angular/core";
...
var MarkdownService = class _MarkdownService {
    ...
    parse(markdown, parseOptions = this.DEFAULT_PARSE_OPTIONS) {
        const { decodeHtml, inline: inline2, emoji, mermaid: mermaid2, disableSanitizer } = parseOptions;
    ...
    render(element, options2 = this.DEFAULT_RENDER_OPTIONS, viewContainerRef) {
        const { clipboard, clipboardOptions, katex: katex2, katexOptions, mermaid: mermaid2, mermaidOptions } = options2;
        if (katex2) {
    ...
    renderClipboard(element, viewContainerRef, options2) {
        ...
        const { buttonComponent, buttonTemplate } = options2;
    ...
    static {
        this.ɵfac = function MarkdownService_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _MarkdownService)(i0.ɵɵinject(CLIPBOARD_OPTIONS, 8), i0.ɵɵinject(MARKED_EXTENSIONS, 8), i0.ɵɵinject(MARKED_OPTIONS, 8), i0.ɵɵinject(MERMAID_OPTIONS, 8), i0.ɵɵinject(PLATFORM_ID), i0.ɵɵinject(SECURITY_CONTEXT), i0.ɵɵinject(i1.HttpClient, 8), i0.ɵɵinject(i2.DomSanitizer));
        };
    }
    static {
...
var MarkdownComponent = class _MarkdownComponent {
    ...
    static {
        this.ɵfac = function MarkdownComponent_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _MarkdownComponent)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(MarkdownService), i0.ɵɵdirectiveInject(i0.ViewContainerRef));
        };
    }
    static {
        this.ɵcmp = /* @__PURE__ */ i0.ɵɵdefineComponent({
...
var MarkdownPipe = class _MarkdownPipe {
    ...
    static {
        this.ɵfac = function MarkdownPipe_Factory(__ngFactoryType__) {
            return new (__ngFactoryType__ || _MarkdownPipe)(i0.ɵɵdirectiveInject(i2.DomSanitizer, 16), i0.ɵɵdirectiveInject(i0.ElementRef, 16), i0.ɵɵdirectiveInject(MarkdownService, 16), i0.ɵɵdirectiveInject(i0.ViewContainerRef, 16), i0.ɵɵdirectiveInject(i0.NgZone, 16));
        };
    }
    static {
        this.ɵpipe = /* @__PURE__ */ i0.ɵɵdefinePipe({
...
function provideMarkdown(markdownModuleConfig) {
    return [MarkdownService, markdownModuleConfig?.loader ?? [], markdownModuleConfig?.clipboardOptions ?? [], markdownModuleConfig?.markedOptions ?? [], markdownModuleConfig?.mermaidOptions ?? [], markdownModuleConfig?.markedExtensions ?? [], {
            ...
            useValue: markdownModuleConfig?.sanitize ?? SecurityContext2.HTML
        }];
}
...
export { CLIPBOARD_OPTIONS, ClipboardButtonComponent, ExtendedRenderer, KatexSpecificOptions, LanguagePipe, MARKED_EXTENSIONS, MARKED_OPTIONS, MERMAID_OPTIONS, MarkdownComponent, MarkdownModule, MarkdownPipe, MarkdownService, _Renderer as MarkedRenderer, PrismPlugin, SECURITY_CONTEXT, errorClipboardNotLoaded, errorClipboardViewContainerRequired, errorJoyPixelsNotLoaded, errorKatexNotLoaded, errorMermaidNotLoaded, errorSrcWithoutHttpClient, provideMarkdown };
