import { a as Bt, b as Pt } from "@nf-internal/chunk-INJBHWGE";
import "@nf-internal/chunk-M4JCPEPJ";
import { k as Ne } from "@nf-internal/chunk-STIBVO4O";
import { a as Y, b as K } from "@nf-internal/chunk-2AVGQ2MQ";
import * as a from "@angular/core";
import { \u0275findLocaleData as y, \u0275LocaleDataIndex as f, \u0275getLocaleCurrencyCode as jt, \u0275getLocalePluralCase as Vt, \u0275RuntimeError as _, \u0275formatRuntimeError as Zi, LOCALE_ID as $, createNgModule as Gt, NgModuleRef as Ht, RendererStyleFlags2 as Zt, inject as Wt, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as Yt, \u0275isPromise as Kt, \u0275isSubscribable as Xt, untracked as He, InjectionToken as et, DEFAULT_CURRENCY_CODE as qt } from "@angular/core";
import * as M from "@angular/core";
import { inject as q, InjectionToken as xe, DOCUMENT as Ue, \u0275\u0275inject as Nt } from "@angular/core";
var ze = null;
function X() { return ze; }
function kt(e) { ze ??= e; }
var De = class {
}, U = (() => { class e {
    historyGo(t) { throw new Error(""); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = M.\u0275\u0275defineInjectable({ token: e, factory: () => q(je), providedIn: "platform" });
} return e; })(), $t = new xe(""), je = (() => { class e extends U {
    _location;
    _history;
    _doc = q(Ue);
...
function ke(e) { let i = e.search(/#|\?|$/); return e[i - 1] === "/" ? e.slice(0, i - 1) + e.slice(i) : e; }
function v(e) { return e && e[0] !== "?" ? `?${e}` : e; }
var k = (() => { class e {
    historyGo(t) { throw new Error(""); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = M.\u0275\u0275defineInjectable({ token: e, factory: () => q(Ve), providedIn: "root" });
} return e; })(), Q = new xe(""), Ve = (() => { class e extends k {
    _platformLocation;
    _baseHref;
    _removeListenerFns = [];
    constructor(t, n) { super(), this._platformLocation = t, this._baseHref = n ?? this._platformLocation.getBaseHrefFromDOM() ?? q(Ue).location?.origin ?? ""; }
    ...
    constructor(t) { this._locationStrategy = t; let n = this._locationStrategy.getBaseHref(); this._basePath = zt(ke($e(n))), this._locationStrategy.onPopState(r => { this._subject.next({ url: this.path(!0), pop: !0, state: r.state, type: r.type }); }); }
    ...
    normalize(t) { return e.stripTrailingSlash(Ut(this._basePath, $e(t))); }
...
var ut = Vt;
function ct(e) { if (!e[f.ExtraData])
    throw new _(2303, !1); }
function dt(e) { let i = y(e); return ct(i), (i[f.ExtraData][2] || []).map(n => typeof n == "string" ? pe(n) : [pe(n[0]), pe(n[1])]); }
function lt(e, i, t) { let n = y(e); ct(n); let r = [n[f.ExtraData][0], n[f.ExtraData][1]], o = b(r, i) || []; return b(o, t) || []; }
...
function ft(e, i, t = "en") { let n = on(t)[e] || tt[e] || [], r = n[1]; return i === "narrow" && typeof r == "string" ? r : n[0] || e; }
var an = 2;
function ht(e) { let i, t = tt[e]; return t && (i = t[2]), typeof i == "number" ? i : an; }
...
function gt(e, i, t, n) { let r = Cn(e); i = T(t, i) || i; let s = [], u; for (; i;)
    if (u = cn.exec(i), u) {
        ...
        s.push(i);
        break;
    } let D = r.getTimezoneOffset(); n && (D = pt(n, D), r = mn(r, n)); let h = ""; return s.forEach(g => { let c = Dn(g); h += c ? c(r, t, D) : g === "''" ? "'" : g.replace(/(^'|'$)/g, "").replace(/''/g, "'"); }), h; }
function oe(e, i, t) { let n = new Date(0); return n.setFullYear(e, i, t), n.setHours(0, 0, 0), n; }
function T(e, i) { let t = it(e); if (ee[t] ??= {}, ee[t][i])
...
function fn(e, i, t, n, r, o) { switch (t) {
    ...
    case 1: return ot(i, r, n)[e.getDay()];
    case 0:
        let s = e.getHours(), u = e.getMinutes();
        if (o) {
            let h = dt(i), g = lt(i, r, n), c = h.findIndex(F => { if (Array.isArray(F)) {
        ...
        return rt(i, r, n)[s < 12 ? 0 : 1];
    case 3: return at(i, n)[e.getFullYear() <= 0 ? 0 : 1];
    default:
        let D = t;
        throw new _(2302, !1);
} }
...
function Dt(e) { let i = e.getDay(), t = i === 0 ? -3 : re - i; return oe(e.getFullYear(), e.getMonth(), e.getDate() + t); }
function me(e, i = !1) { return function (t, n) { let r; if (i) {
    ...
    let o = Dt(t), s = gn(o.getFullYear()), u = o.getTime() - s.getTime();
    r = 1 + Math.round(u / 6048e5);
} return I(r, e, S(n, m.MinusSign)); }; }
function ie(e, i = !1) { return function (t, n) { let o = Dt(t).getFullYear(); return I(o, e, S(n, m.MinusSign), i); }; }
var Ce = {};
...
function pt(e, i) { e = e.replace(/:/g, ""); let t = Date.parse("Jan 01, 1970 00:00:00 " + e) / 6e4; return isNaN(t) ? i : t; }
function pn(e, i) { return e = new Date(e.getTime()), e.setMinutes(e.getMinutes() + i), e; }
function mn(e, i, t) { let r = e.getTimezoneOffset(), o = pt(i, r); return pn(e, -1 * (o - r)); }
function Cn(e) { if (Ze(e))
...
function Ze(e) { return e instanceof Date && !isNaN(e.valueOf()); }
var Fn = /^(\d+)?\.((\d+)(-(\d+))?)?$/, We = 22, se = ".", G = "0", En = ";", wn = ",", ye = "#", Ye = "\xA4", An = "%";
...
function mt(e, i, t, n, r) { let o = ce(i, Z.Currency), s = _e(o, S(i, m.MinusSign)); return s.minFrac = ht(n), s.maxFrac = s.minFrac, Se(e, s, i, m.CurrencyGroup, m.CurrencyDecimal, r).replace(Ye, t).replace(Ye, "").trim(); }
function Ct(e, i, t) { let n = ce(i, Z.Percent), r = _e(n, S(i, m.MinusSign)); return Se(e, r, i, m.Group, m.Decimal, t, !0).replace(new RegExp(An, "g"), S(i, m.PercentSign)); }
function yt(e, i, t) { let n = ce(i, Z.Decimal), r = _e(n, S(i, m.MinusSign)); return Se(e, r, i, m.Group, m.Decimal, t); }
...
} return r > We && (n = n.splice(0, We - 1), t = r - 1, r = 1), { digits: n, exponent: t, integerLen: r }; }
...
var de = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = a.\u0275\u0275defineInjectable({ token: e, factory: function (n) { let r = null; return n ? r = new n : r = (o => new Et(o))(a.\u0275\u0275inject($)), r; }, providedIn: "root" });
} return e; })();
...
var Et = (() => { class e extends de {
    ...
    set klass(t) { this.initialClasses = t != null ? t.trim().split(Ee) : Ke; }
    ...
    ngOnChanges(t) { if (this._needToReCreateComponentInstance(t) && (this._viewContainerRef.clear(), this._inputsUsed.clear(), this._componentRef = void 0, this.ngComponentOutlet)) {
        ...
        this._needToReCreateNgModuleInstance(t) && (this._moduleRef?.destroy(), this.ngComponentOutletNgModule ? this._moduleRef = Gt(this.ngComponentOutletNgModule, Xe(n)) : this.ngComponentOutletNgModuleFactory ? this._moduleRef = this.ngComponentOutletNgModuleFactory.create(Xe(n)) : this._moduleRef = void 0), this._componentRef = this._viewContainerRef.createComponent(this.ngComponentOutlet, { injector: n, ngModuleRef: this._moduleRef, projectableNodes: this.ngComponentOutletContent, environmentInjector: this.ngComponentOutletEnvironmentInjector });
    } }
...
function Xe(e) { return e.get(Ht).injector; }
var ae = class {
    $implicit;
    ngForOf;
    index;
    ...
    } t.forEachIdentityChange(r => { let o = n.get(r.currentIndex); qe(o, r); }); }
...
function qe(e, i) { e.context.$implicit = i.item; }
var Ln = (() => { class e {
    _viewContainer;
    _context = new ue;
    ...
    set ngIfThen(t) { Je(t, !1), this._thenTemplateRef = t, this._thenViewRef = null, this._updateView(); }
    set ngIfElse(t) { Je(t, !1), this._elseTemplateRef = t, this._elseViewRef = null, this._updateView(); }
...
function Je(e, i) { if (e && !e.createEmbeddedView)
    throw new _(2020, !1); }
var H = class {
    _viewContainerRef;
    _templateRef;
...
var At = (() => { class e {
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275injectAttribute("ngPluralCase"), a.\u0275\u0275directiveInject(a.TemplateRef), a.\u0275\u0275directiveInject(a.ViewContainerRef), a.\u0275\u0275directiveInject(At, 1)); };
...
var we = class {
    createSubscription(i, t, n) { return He(() => i.subscribe({ next: t, error: n })); }
    dispose(i) { He(() => i.unsubscribe()); }
}, Ae = class {
...
} return e; })(), jn = "mediumDate", St = new et(""), _t = new et(""), Vn = (() => { class e {
    locale;
    defaultTimezone;
    defaultOptions;
    ...
    transform(t, n, r, o) { if (t == null || t === "" || t !== t)
        ...
        return gt(t, s, o || this.locale, u);
    }
    catch (s) {
        throw L(e, s.message);
    } }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject($, 16), a.\u0275\u0275directiveInject(St, 24), a.\u0275\u0275directiveInject(_t, 24)); };
    ...
    transform(t, n, r) { if (t == null)
        ...
        throw L(e, n); let o = Ft(t, Object.keys(n), this._localization, r); return n[o].replace(Gn, t.toString()); }
...
var Xn = (() => { class e {
    ...
    transform(t, n = this._defaultCurrencyCode, r = "symbol", o, s) { if (!ve(t))
        return null; s ||= this._locale, typeof r == "boolean" && (r = r ? "symbol" : "code"); let u = n || this._defaultCurrencyCode; r !== "code" && (r === "symbol" || r === "symbol-narrow" ? u = ft(u, r === "symbol" ? "wide" : "narrow", s) : u = r); try {
        let D = Ie(t);
        return mt(D, s, u, n, o);
    }
    catch (D) {
...
import { \u0275registerLocaleData as ni, Version as ii, \u0275\u0275defineInjectable as ri, inject as O, DOCUMENT as Mt, \u0275formatRuntimeError as oi, InjectionToken as Te, \u0275RuntimeError as Oe, \u0275IMAGE_CONFIG as si, Renderer2 as ai, ElementRef as ui, Injector as ci, \u0275performanceMarkFeature as di, numberAttribute as vt, booleanAttribute as le, \u0275IMAGE_CONFIG_DEFAULTS as li, \u0275unwrapSafeValue as fi, ChangeDetectorRef as hi } from "@angular/core";
import { DOCUMENT as Ir, \u0275IMAGE_CONFIG as Lr } from "@angular/core";
import * as bt from "@angular/core";
import "@angular/core";
var ti = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = bt.\u0275\u0275defineInjectable({ token: e, factory: () => window.navigation, providedIn: "platform" });
} return e; })();
function hr(e, i, t) { return ni(e, i, t); }
var gi = "browser", Di = "server";
function gr(e) { return e === gi; }
function Dr(e) { return e === Di; }
var pr = new ii("20.3.7"), mr = (() => { class e {
    static \u0275prov = ri({ token: e, providedIn: "root", factory: () => typeof ngServerMode < "u" && ngServerMode ? new Me : new Le(O(Mt), window) });
} return e; })(), Le = class {
    document;
    window;
    offset = () => [0, 0];
...
function Tt(e) { return /^https?:\/\//.test(e); }
function Ot(e) { if (!(typeof e == "string") || e.trim() === "")
    return !1; try {
    let t = new URL(e);
    return !0;
}
...
var Rt = e => e.src, Re = new Te("", { providedIn: "root", factory: () => Rt });
function he(e, i) { return function (n) { return Ot(n) || yi(n, i || []), n = mi(n), [{ provide: Re, useValue: s => (Tt(s.src) && Fi(n, s.src), e(n, K(Y({}, s), { src: Ci(s.src) }))) }]; }; }
...
function wr(e) { if (e && !Ot(e))
    throw new Oe(2959, !1); return e && (e = new URL(e).origin), [{ provide: Re, useValue: n => _i(n, e) }]; }
var It = new Map([["height", "h"], ["fit", "fit"], ["quality", "q"], ["q", "q"], ["position", "position"]]);
function _i(e, i) { let t = new URL(i ?? "https://a/"); t.pathname = "/.netlify/images", !Tt(e.src) && !e.src.startsWith("/") && (e.src = "/" + e.src), t.searchParams.set("url", e.src), e.width && t.searchParams.set("w", e.width.toString()); let n = e.loaderParams?.quality ?? e.loaderParams?.q; e.isPlaceholder && !n && t.searchParams.set("q", fe); for (let [r, o] of Object.entries(e.loaderParams ?? {}))
    It.has(r) && t.searchParams.set(It.get(r), o.toString()); return t.hostname === "a" ? t.href.replace(t.origin, "") : t.href; }
var Ar = new Te("");
...
var Sr = (() => { class e {
    ...
    setHostAttributes() { this.fill ? this.sizes ||= "100vw" : (this.setHostAttribute("width", this.width.toString()), this.setHostAttribute("height", this.height.toString())), this.setHostAttribute("loading", this.getLoadingBehavior()), this.setHostAttribute("fetchpriority", this.getFetchPriority()), this.setHostAttribute("decoding", this.getDecoding()), this.setHostAttribute("ng-img", "true"); let t = this.updateSrcAndSrcset(); this.sizes ? this.getLoadingBehavior() === "lazy" ? this.setHostAttribute("sizes", "auto, " + this.sizes) : this.setHostAttribute("sizes", this.sizes) : this.ngSrcset && Lt.test(this.ngSrcset) && this.getLoadingBehavior() === "lazy" && this.setHostAttribute("sizes", "auto, 100vw"), typeof ngServerMode < "u" && ngServerMode && this.priority && this.injector.get(vi).createPreloadLinkTag(this.renderer, this.getRewrittenSrc(), t, this.sizes); }
    ...
    getRewrittenSrcset() { let t = Lt.test(this.ngSrcset); return this.ngSrcset.split(",").filter(r => r !== "").map(r => { r = r.trim(); let o = t ? parseFloat(r) : parseFloat(r) * this.width; return `${this.callImageLoader({ src: this.ngSrc, width: o })} ${r}`; }).join(", "); }
    ...
    shouldGenerateAutomaticSrcset() { let t = !1; return this.sizes || (t = this.width > Mi || this.height > Ti), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== Rt && !t; }
...
export { Q as APP_BASE_HREF, kn as AsyncPipe, je as BrowserPlatformLocation, ei as CommonModule, Jn as CurrencyPipe, _t as DATE_PIPE_DEFAULT_OPTIONS, St as DATE_PIPE_DEFAULT_TIMEZONE, Ir as DOCUMENT, Vn as DatePipe, Xn as DecimalPipe, E as FormStyle, A as FormatWidth, Jt as HashLocationStrategy, Hn as I18nPluralPipe, Zn as I18nSelectPipe, Lr as IMAGE_CONFIG, Re as IMAGE_LOADER, Wn as JsonPipe, Kn as KeyValuePipe, $t as LOCATION_INITIALIZED, Ge as Location, k as LocationStrategy, $n as LowerCasePipe, vn as NgClass, In as NgComponentOutlet, wt as NgFor, wt as NgForOf, ae as NgForOfContext, Ln as NgIf, ue as NgIfContext, Et as NgLocaleLocalization, de as NgLocalization, Sr as NgOptimizedImage, At as NgPlural, On as NgPluralCase, Rn as NgStyle, be as NgSwitch, Mn as NgSwitchCase, Tn as NgSwitchDefault, Bn as NgTemplateOutlet, Z as NumberFormatStyle, m as NumberSymbol, Ar as PRECONNECT_CHECK_BLOCKLIST, Ve as PathLocationStrategy, qn as PercentPipe, U as PlatformLocation, P as Plural, Qn as SlicePipe, Un as TitleCasePipe, d as TranslationWidth, zn as UpperCasePipe, pr as VERSION, mr as ViewportScroller, nt as WeekDay, Pt as XhrFactory, mt as formatCurrency, gt as formatDate, yt as formatNumber, Ct as formatPercent, ft as getCurrencySymbol, rn as getLocaleCurrencyCode, nn as getLocaleCurrencyName, tn as getLocaleCurrencySymbol, z as getLocaleDateFormat, V as getLocaleDateTimeFormat, ot as getLocaleDayNames, rt as getLocaleDayPeriods, sn as getLocaleDirection, at as getLocaleEraNames, dt as getLocaleExtraDayPeriodRules, lt as getLocaleExtraDayPeriods, Qt as getLocaleFirstDayOfWeek, it as getLocaleId, st as getLocaleMonthNames, ce as getLocaleNumberFormat, S as getLocaleNumberSymbol, ut as getLocalePluralCase, j as getLocaleTimeFormat, en as getLocaleWeekEndRange, ht as getNumberOfCurrencyDigits, gr as isPlatformBrowser, Dr as isPlatformServer, Cr as provideCloudflareLoader, yr as provideCloudinaryLoader, Fr as provideImageKitLoader, Er as provideImgixLoader, wr as provideNetlifyLoader, hr as registerLocaleData, De as \u0275DomAdapter, Me as \u0275NullViewportScroller, gi as \u0275PLATFORM_BROWSER_ID, Di as \u0275PLATFORM_SERVER_ID, ti as \u0275PlatformNavigation, X as \u0275getDOM, v as \u0275normalizeQueryParams, Bt as \u0275parseCookieValue, kt as \u0275setRootDomAdapter };
