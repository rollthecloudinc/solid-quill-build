import { a as S } from "@nf-internal/chunk-BFB4EW3O";
import { g as x, i as P } from "@nf-internal/chunk-HFIBVXRL";
import "@nf-internal/chunk-FMFFQTHD";
import { i as v } from "@nf-internal/chunk-WSXZKWFY";
import { b, l as f } from "@nf-internal/chunk-HTPCKVAC";
import "@nf-internal/chunk-D2J64VUP";
import "@nf-internal/chunk-JWKF23VO";
import "@nf-internal/chunk-X7JSYDDX";
import { e as _ } from "@nf-internal/chunk-G53ZESKS";
import "@nf-internal/chunk-HOKO2ONL";
import "@nf-internal/chunk-ARUHDGKS";
import { h } from "@nf-internal/chunk-UTD2NKSC";
...
import { k as m, m as u } from "@nf-internal/chunk-STIBVO4O";
import "@nf-internal/chunk-2AVGQ2MQ";
import * as t from "@angular/core";
import { Optional as I, SkipSelf as y, InjectionToken as C, inject as l, ChangeDetectorRef as T, numberAttribute as p, EventEmitter as D, booleanAttribute as g } from "@angular/core";
...
var E = { provide: d, deps: [[new I, new y, d]], useFactory: A }, R = 50, z = class {
    pageIndex;
    previousPageIndex;
    pageSize;
    length;
}, N = new C("MAT_PAGINATOR_DEFAULT_OPTIONS"), V = (() => {
    class a {
        _intl = l(d);
        _changeDetectorRef = l(T);
        _formFieldAppearance;
        _pageSizeLabelId = l(M).getId("mat-paginator-page-size-label-");
        _intlChanges;
        _isInitialized = !1;
        _initializedStream = new u(1);
        color;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    static \u0275inj = t.\u0275\u0275defineInjector({ providers: [E], imports: [f, P, S, V] });
} return a; })();
export { N as MAT_PAGINATOR_DEFAULT_OPTIONS, E as MAT_PAGINATOR_INTL_PROVIDER, A as MAT_PAGINATOR_INTL_PROVIDER_FACTORY, V as MatPaginator, d as MatPaginatorIntl, vt as MatPaginatorModule, z as PageEvent };
