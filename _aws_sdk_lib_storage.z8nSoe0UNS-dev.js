...
import { getEndpointFromInstructions, toEndpointV1 } from "@nf-internal/chunk-MKAXSSMD";
import { __async, __asyncGenerator, __await, __commonJS, __forAwait, __spreadProps, __spreadValues, __toESM } from "@nf-internal/chunk-VTXF2OHE";
...
var require_buffer = __commonJS({
    "node_modules/buffer/index.js"(exports) {
        ...
        Buffer6.byteLength = byteLength2;
        ...
        Buffer6.prototype.readUIntLE = function readUIntLE(offset, byteLength3, noAssert) {
            offset = offset >>> 0;
        ...
        Buffer6.prototype.readUIntBE = function readUIntBE(offset, byteLength3, noAssert) {
            offset = offset >>> 0;
            byteLength3 = byteLength3 >>> 0;
            if (!noAssert) {
                checkOffset(offset, byteLength3, this.length);
        ...
        Buffer6.prototype.readIntLE = function readIntLE(offset, byteLength3, noAssert) {
            offset = offset >>> 0;
            byteLength3 = byteLength3 >>> 0;
            if (!noAssert)
                checkOffset(offset, byteLength3, this.length);
        ...
        Buffer6.prototype.readIntBE = function readIntBE(offset, byteLength3, noAssert) {
            offset = offset >>> 0;
            byteLength3 = byteLength3 >>> 0;
            if (!noAssert)
                checkOffset(offset, byteLength3, this.length);
        ...
        Buffer6.prototype.writeUIntLE = function writeUIntLE(value, offset, byteLength3, noAssert) {
            value = +value;
            offset = offset >>> 0;
            byteLength3 = byteLength3 >>> 0;
            if (!noAssert) {
        ...
        Buffer6.prototype.writeUIntBE = function writeUIntBE(value, offset, byteLength3, noAssert) {
            value = +value;
            offset = offset >>> 0;
            byteLength3 = byteLength3 >>> 0;
            if (!noAssert) {
        ...
        Buffer6.prototype.writeIntLE = function writeIntLE(value, offset, byteLength3, noAssert) {
            value = +value;
            offset = offset >>> 0;
            if (!noAssert) {
        ...
        Buffer6.prototype.writeIntBE = function writeIntBE(value, offset, byteLength3, noAssert) {
            value = +value;
            offset = offset >>> 0;
            if (!noAssert) {
                var limit = Math.pow(2, 8 * byteLength3 - 1);
        ...
        Buffer6.prototype.fill = function fill(val, start, end, encoding) {
            ...
            if (typeof val === "number") {
                ...
                var bytes = Buffer6.isBuffer(val) ? val : Buffer6.from(val, encoding);
...
var require_string_decoder = __commonJS({
    "node_modules/string_decoder/lib/string_decoder.js"(exports) {
        ...
        function normalizeEncoding(enc) {
            ...
            if (typeof nenc !== "string" && (Buffer6.isEncoding === isEncoding || !isEncoding(enc)))
...
var runtimeConfig = __spreadProps(__spreadValues({}, runtimeConfigShared), {
    runtime: "browser"
});
// node_modules/@aws-sdk/lib-storage/dist-es/byteLength.js
...
var Upload = class _Upload extends import_events.EventEmitter {
    ...
    __uploadUsingPut(dataPart) {
        return __async(this, null, function* () {
            ...
            const params = __spreadProps(__spreadValues({}, this.params), {
                Body: dataPart.data
            });
            ...
            const resolved = yield Promise.all([this.client.send(new PutObjectCommand(params)), clientConfig?.endpoint?.()]);
    ...
    __createMultipartUpload() {
        return __async(this, null, function* () {
            const requestChecksumCalculation = yield this.client.config.requestChecksumCalculation();
            if (!this.createMultiPartPromise) {
                const createCommandParams = __spreadProps(__spreadValues({}, this.params), {
                    Body: void 0
                });
