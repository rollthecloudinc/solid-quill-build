...
import { Subscription, of, throwError } from "@nf-internal/chunk-4WPE7WTU";
// node_modules/@angular/material/fesm2022/icon.mjs
import * as i02 from "@angular/core";
import { InjectionToken, inject, DOCUMENT as DOCUMENT2, ElementRef, ErrorHandler as ErrorHandler3, HostAttributeToken, booleanAttribute, Component, ViewEncapsulation, ChangeDetectionStrategy, Input, NgModule } from "@angular/core";
...
import { SecurityContext, DOCUMENT, Injectable, Optional, Inject, SkipSelf, ErrorHandler as ErrorHandler2 } from "@angular/core";
...
var MatIconRegistry = class _MatIconRegistry {
    ...
    static ɵfac = function MatIconRegistry_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || _MatIconRegistry)(i0.ɵɵinject(i1.HttpClient, 8), i0.ɵɵinject(i2.DomSanitizer), i0.ɵɵinject(DOCUMENT, 8), i0.ɵɵinject(i0.ErrorHandler));
    };
...
var ICON_REGISTRY_PROVIDER = {
    ...
    deps: [[new Optional(), new SkipSelf(), MatIconRegistry], [new Optional(), HttpClient2], DomSanitizer2, ErrorHandler2, [new Optional(), DOCUMENT]],
...
function MAT_ICON_LOCATION_FACTORY() {
    const _document = inject(DOCUMENT2);
...
var MatIcon = class _MatIcon {
    ...
    _errorHandler = inject(ErrorHandler3);
    _defaultColor;
    /**
    ...
    static ɵcmp = /* @__PURE__ */ i02.ɵɵdefineComponent({
        ...
        hostBindings: function MatIcon_HostBindings(rf, ctx) {
            if (rf & 2) {
                i02.ɵɵattribute("data-mat-icon-type", ctx._usingFontIcon() ? "font" : "svg")("data-mat-icon-name", ctx._svgName || ctx.fontIcon)("data-mat-icon-namespace", ctx._svgNamespace || ctx.fontSet)("fontIcon", ctx._usingFontIcon() ? ctx.fontIcon : null);
                i02.ɵɵclassMap(ctx.color ? "mat-" + ctx.color : "");
                i02.ɵɵclassProp("mat-icon-inline", ctx.inline)("mat-icon-no-color", ctx.color !== "primary" && ctx.color !== "accent" && ctx.color !== "warn");
            }
        },
        inputs: {
            color: "color",
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(MatIcon, [{
            type: Component,
            args: [{
...
(() => {
    (typeof ngDevMode === "undefined" || ngDevMode) && i02.ɵsetClassMetadata(MatIconModule, [{
            type: NgModule,
            args: [{
...
export { getMatIconNameNotFoundError, getMatIconNoHttpProviderError, getMatIconFailedToSanitizeUrlError, getMatIconFailedToSanitizeLiteralError, MatIconRegistry, ICON_REGISTRY_PROVIDER_FACTORY, ICON_REGISTRY_PROVIDER, MAT_ICON_DEFAULT_OPTIONS, MAT_ICON_LOCATION, MAT_ICON_LOCATION_FACTORY, MatIcon, MatIconModule };
